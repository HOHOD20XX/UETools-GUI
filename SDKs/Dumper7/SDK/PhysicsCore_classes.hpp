...
static_assert(offsetof(UPhysicalMaterial, OcclusionAffect) == 0x00006C, "Member 'UPhysicalMaterial::OcclusionAffect' has a wrong offset!");
static_assert(offsetof(UPhysicalMaterial, IgnoreComponentOcclussionAffect) == 0x000070, "Member 'UPhysicalMaterial::IgnoreComponentOcclussionAffect' has a wrong offset!");
