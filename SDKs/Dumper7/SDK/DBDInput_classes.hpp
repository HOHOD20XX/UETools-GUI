...
static_assert(sizeof(UDBDInputManager) == 0x000118, "Wrong size on UDBDInputManager");
...
static_assert(sizeof(UMultipleGamepadsControlModeInfo) == 0x000058, "Wrong size on UMultipleGamepadsControlModeInfo");
...
static_assert(sizeof(UVirtualKeyboardManager) == 0x000070, "Wrong size on UVirtualKeyboardManager");
