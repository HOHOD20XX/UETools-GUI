...
{
public:
	const class UUserWidget*                      presenterRootWidget;                               // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(InteractiveWidgetInterface_HandleAnalogInputEvent) == 0x000048, "Wrong size on InteractiveWidgetInterface_HandleAnalogInputEvent");
...
static_assert(sizeof(InteractiveWidgetInterface_HandleKeyDownEvent) == 0x000040, "Wrong size on InteractiveWidgetInterface_HandleKeyDownEvent");
...
static_assert(sizeof(InteractiveWidgetInterface_HandleKeyHoldEvent) == 0x000040, "Wrong size on InteractiveWidgetInterface_HandleKeyHoldEvent");
...
static_assert(sizeof(InteractiveWidgetInterface_HandleKeyUpEvent) == 0x000040, "Wrong size on InteractiveWidgetInterface_HandleKeyUpEvent");
