...
static_assert(sizeof(USimplygonStandinPipeline) == 0x000068, "Wrong size on USimplygonStandinPipeline");
...
static_assert(sizeof(UStandinNearPipeline) == 0x000208, "Wrong size on UStandinNearPipeline");
static_assert(offsetof(UStandinNearPipeline, Settings) == 0x000068, "Member 'UStandinNearPipeline::Settings' has a wrong offset!");
...
static_assert(sizeof(UStandinFarPipeline) == 0x000210, "Wrong size on UStandinFarPipeline");
static_assert(offsetof(UStandinFarPipeline, Settings) == 0x000068, "Member 'UStandinFarPipeline::Settings' has a wrong offset!");
...
static_assert(sizeof(UBillboardCloudPipeline) == 0x000158, "Wrong size on UBillboardCloudPipeline");
static_assert(offsetof(UBillboardCloudPipeline, Settings) == 0x000068, "Member 'UBillboardCloudPipeline::Settings' has a wrong offset!");
...
static_assert(sizeof(UFlipbookPipeline) == 0x000108, "Wrong size on UFlipbookPipeline");
...
static_assert(sizeof(UBillboardCloudVegetationPipeline) == 0x000120, "Wrong size on UBillboardCloudVegetationPipeline");
...
static_assert(sizeof(USimplygonColorCaster) == 0x000068, "Wrong size on USimplygonColorCaster");
...
static_assert(sizeof(UBaseColorCaster) == 0x000068, "Wrong size on UBaseColorCaster");
...
static_assert(sizeof(UMetallicCaster) == 0x000068, "Wrong size on UMetallicCaster");
...
static_assert(sizeof(USpecualarCaster) == 0x000068, "Wrong size on USpecualarCaster");
...
static_assert(sizeof(URoughnessCaster) == 0x000068, "Wrong size on URoughnessCaster");
...
static_assert(sizeof(USimplygonNormalCaster) == 0x000068, "Wrong size on USimplygonNormalCaster");
...
static_assert(sizeof(UNormalCaster) == 0x000068, "Wrong size on UNormalCaster");
...
static_assert(sizeof(USimplygonOpacityCaster) == 0x000068, "Wrong size on USimplygonOpacityCaster");
...
static_assert(sizeof(UOpacityCaster) == 0x000068, "Wrong size on UOpacityCaster");
...
static_assert(sizeof(UEmissiveCaster) == 0x000068, "Wrong size on UEmissiveCaster");
...
static_assert(sizeof(UOpacityMaskCaster) == 0x000068, "Wrong size on UOpacityMaskCaster");
...
static_assert(sizeof(UAmbientOcclusionMaskCaster) == 0x000068, "Wrong size on UAmbientOcclusionMaskCaster");
...
static_assert(sizeof(UReductionPipeline) == 0x000240, "Wrong size on UReductionPipeline");
...
static_assert(sizeof(URemeshingPipeline) == 0x0001D8, "Wrong size on URemeshingPipeline");
...
static_assert(sizeof(UAggregationPipeline) == 0x0001D0, "Wrong size on UAggregationPipeline");
...
static_assert(sizeof(USimplygonDisplacementCaster) == 0x000070, "Wrong size on USimplygonDisplacementCaster");
...
static_assert(sizeof(USimplygonAmbientOcclusionCaster) == 0x000078, "Wrong size on USimplygonAmbientOcclusionCaster");
...
static_assert(sizeof(USimplygonVertexColorCaster) == 0x000080, "Wrong size on USimplygonVertexColorCaster");
