...
static_assert(sizeof(PlayMontageCallbackProxy_OnMontageBlendingOut) == 0x000020, "Wrong size on PlayMontageCallbackProxy_OnMontageBlendingOut");
static_assert(offsetof(PlayMontageCallbackProxy_OnMontageBlendingOut, MontageInstanceId) == 0x000000, "Member 'PlayMontageCallbackProxy_OnMontageBlendingOut::MontageInstanceId' has a wrong offset!");
static_assert(offsetof(PlayMontageCallbackProxy_OnMontageBlendingOut, Montage) == 0x000010, "Member 'PlayMontageCallbackProxy_OnMontageBlendingOut::Montage' has a wrong offset!");
static_assert(offsetof(PlayMontageCallbackProxy_OnMontageBlendingOut, bInterrupted) == 0x000018, "Member 'PlayMontageCallbackProxy_OnMontageBlendingOut::bInterrupted' has a wrong offset!");
...
static_assert(sizeof(PlayMontageCallbackProxy_OnMontageEnded) == 0x000020, "Wrong size on PlayMontageCallbackProxy_OnMontageEnded");
static_assert(offsetof(PlayMontageCallbackProxy_OnMontageEnded, MontageInstanceId) == 0x000000, "Member 'PlayMontageCallbackProxy_OnMontageEnded::MontageInstanceId' has a wrong offset!");
static_assert(offsetof(PlayMontageCallbackProxy_OnMontageEnded, Montage) == 0x000010, "Member 'PlayMontageCallbackProxy_OnMontageEnded::Montage' has a wrong offset!");
static_assert(offsetof(PlayMontageCallbackProxy_OnMontageEnded, bInterrupted) == 0x000018, "Member 'PlayMontageCallbackProxy_OnMontageEnded::bInterrupted' has a wrong offset!");
