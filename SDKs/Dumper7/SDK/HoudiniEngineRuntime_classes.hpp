...
public:
	...
	int32                                         AssetId;                                           // 0x06AC(0x0004)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<int32>                                 NodeIdsToCook;                                     // 0x06B0(0x0010)(ZeroConstructor, Transient, DuplicateTransient, Protected, NativeAccessSpecifierProtected)
	TSet<class UHoudiniAssetComponent*>           DownstreamHoudiniAssets;                           // 0x06C0(0x0050)(ExportObject, DuplicateTransient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	...
	uint32                                        SubAssetIndex;                                     // 0x0744(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         AssetCookCount;                                    // 0x0748(0x0004)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TMap<class UObject*, int32>                   InputPresets;                                      // 0x07F0(0x0050)(Transient, DuplicateTransient, Protected, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_841[0x5F];                                     // 0x0841(0x005F)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UHoudiniAssetComponent) == 0x0008D0, "Wrong size on UHoudiniAssetComponent");
static_assert(offsetof(UHoudiniAssetComponent, HoudiniAsset) == 0x000488, "Member 'UHoudiniAssetComponent::HoudiniAsset' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnParameterChange) == 0x000490, "Member 'UHoudiniAssetComponent::bCookOnParameterChange' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bUploadTransformsToHoudiniEngine) == 0x000491, "Member 'UHoudiniAssetComponent::bUploadTransformsToHoudiniEngine' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnTransformChange) == 0x000492, "Member 'UHoudiniAssetComponent::bCookOnTransformChange' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnAssetInputCook) == 0x000493, "Member 'UHoudiniAssetComponent::bCookOnAssetInputCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOutputless) == 0x000494, "Member 'UHoudiniAssetComponent::bOutputless' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOutputTemplateGeos) == 0x000495, "Member 'UHoudiniAssetComponent::bOutputTemplateGeos' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bUseOutputNodes) == 0x000496, "Member 'UHoudiniAssetComponent::bUseOutputNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, TemporaryCookFolder) == 0x000498, "Member 'UHoudiniAssetComponent::TemporaryCookFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakeFolder) == 0x0004A8, "Member 'UHoudiniAssetComponent::BakeFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshMethod) == 0x0004B8, "Member 'UHoudiniAssetComponent::StaticMeshMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshGenerationProperties) == 0x0004C0, "Member 'UHoudiniAssetComponent::StaticMeshGenerationProperties' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshBuildSettings) == 0x000670, "Member 'UHoudiniAssetComponent::StaticMeshBuildSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOverrideGlobalProxyStaticMeshSettings) == 0x0006A0, "Member 'UHoudiniAssetComponent::bOverrideGlobalProxyStaticMeshSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshOverride) == 0x0006A1, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementByTimerOverride) == 0x0006A2, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementByTimerOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, ProxyMeshAutoRefineTimeoutSecondsOverride) == 0x0006A4, "Member 'UHoudiniAssetComponent::ProxyMeshAutoRefineTimeoutSecondsOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride) == 0x0006A8, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride) == 0x0006A9, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetId) == 0x0006AC, "Member 'UHoudiniAssetComponent::AssetId' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, NodeIdsToCook) == 0x0006B0, "Member 'UHoudiniAssetComponent::NodeIdsToCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, DownstreamHoudiniAssets) == 0x0006C0, "Member 'UHoudiniAssetComponent::DownstreamHoudiniAssets' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, ComponentGUID) == 0x000710, "Member 'UHoudiniAssetComponent::ComponentGUID' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HapiGUID) == 0x000720, "Member 'UHoudiniAssetComponent::HapiGUID' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HapiAssetName) == 0x000730, "Member 'UHoudiniAssetComponent::HapiAssetName' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetState) == 0x000740, "Member 'UHoudiniAssetComponent::AssetState' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, DebugLastAssetState) == 0x000741, "Member 'UHoudiniAssetComponent::DebugLastAssetState' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetStateResult) == 0x000742, "Member 'UHoudiniAssetComponent::AssetStateResult' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, SubAssetIndex) == 0x000744, "Member 'UHoudiniAssetComponent::SubAssetIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetCookCount) == 0x000748, "Member 'UHoudiniAssetComponent::AssetCookCount' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenLoaded) == 0x00074C, "Member 'UHoudiniAssetComponent::bHasBeenLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenDuplicated) == 0x00074D, "Member 'UHoudiniAssetComponent::bHasBeenDuplicated' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bPendingDelete) == 0x00074E, "Member 'UHoudiniAssetComponent::bPendingDelete' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRecookRequested) == 0x00074F, "Member 'UHoudiniAssetComponent::bRecookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRebuildRequested) == 0x000750, "Member 'UHoudiniAssetComponent::bRebuildRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableCooking) == 0x000751, "Member 'UHoudiniAssetComponent::bEnableCooking' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bForceNeedUpdate) == 0x000752, "Member 'UHoudiniAssetComponent::bForceNeedUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bLastCookSuccess) == 0x000753, "Member 'UHoudiniAssetComponent::bLastCookSuccess' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bParameterDefinitionUpdateNeeded) == 0x000754, "Member 'UHoudiniAssetComponent::bParameterDefinitionUpdateNeeded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintStructureModified) == 0x000755, "Member 'UHoudiniAssetComponent::bBlueprintStructureModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintModified) == 0x000756, "Member 'UHoudiniAssetComponent::bBlueprintModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Parameters) == 0x000758, "Member 'UHoudiniAssetComponent::Parameters' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Inputs) == 0x000768, "Member 'UHoudiniAssetComponent::Inputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Outputs) == 0x000778, "Member 'UHoudiniAssetComponent::Outputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakedOutputs) == 0x000788, "Member 'UHoudiniAssetComponent::BakedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, UntrackedOutputs) == 0x000798, "Member 'UHoudiniAssetComponent::UntrackedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HandleComponents) == 0x0007A8, "Member 'UHoudiniAssetComponent::HandleComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasComponentTransformChanged) == 0x0007B8, "Member 'UHoudiniAssetComponent::bHasComponentTransformChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bFullyLoaded) == 0x0007B9, "Member 'UHoudiniAssetComponent::bFullyLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, PDGAssetLink) == 0x0007C0, "Member 'UHoudiniAssetComponent::PDGAssetLink' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, RefineMeshesTimer) == 0x0007C8, "Member 'UHoudiniAssetComponent::RefineMeshesTimer' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bNoProxyMeshNextCookRequested) == 0x0007E8, "Member 'UHoudiniAssetComponent::bNoProxyMeshNextCookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, InputPresets) == 0x0007F0, "Member 'UHoudiniAssetComponent::InputPresets' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBakeAfterNextCook) == 0x000840, "Member 'UHoudiniAssetComponent::bBakeAfterNextCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCachedIsPreview) == 0x0008A0, "Member 'UHoudiniAssetComponent::bCachedIsPreview' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, LastTickTime) == 0x0008B0, "Member 'UHoudiniAssetComponent::LastTickTime' has a wrong offset!");
...
{
public:
	uint8                                         Pad_8D0[0x48];                                     // 0x08D0(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_91E[0xA];                                      // 0x091E(0x000A)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UHoudiniAssetBlueprintComponent) == 0x0009D0, "Wrong size on UHoudiniAssetBlueprintComponent");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, FauxBPProperty) == 0x000918, "Member 'UHoudiniAssetBlueprintComponent::FauxBPProperty' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bHoudiniAssetChanged) == 0x000919, "Member 'UHoudiniAssetBlueprintComponent::bHoudiniAssetChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bUpdatedFromTemplate) == 0x00091A, "Member 'UHoudiniAssetBlueprintComponent::bUpdatedFromTemplate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bIsInBlueprintEditor) == 0x00091B, "Member 'UHoudiniAssetBlueprintComponent::bIsInBlueprintEditor' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bCanDeleteHoudiniNodes) == 0x00091C, "Member 'UHoudiniAssetBlueprintComponent::bCanDeleteHoudiniNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bHasRegisteredComponentTemplate) == 0x00091D, "Member 'UHoudiniAssetBlueprintComponent::bHasRegisteredComponentTemplate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, CachedOutputNodes) == 0x000928, "Member 'UHoudiniAssetBlueprintComponent::CachedOutputNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, CachedInputNodes) == 0x000978, "Member 'UHoudiniAssetBlueprintComponent::CachedInputNodes' has a wrong offset!");
...
// 0x0520 (0x09A0 - 0x0480)
class UHoudiniAssetComponent_V1 final : public UPrimitiveComponent
{
public:
	uint8                                         bGeneratedDoubleSidedGeometry : 1;                 // 0x0480(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	int32                                         GeneratedLightMapResolution;                       // 0x05F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         GeneratedLightMapCoordinateIndex;                  // 0x060C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bGeneratedUseMaximumStreamingTexelRatio : 1;       // 0x0610(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UHoudiniAssetComponent_V1) == 0x0009A0, "Wrong size on UHoudiniAssetComponent_V1");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedPhysMaterial) == 0x000488, "Member 'UHoudiniAssetComponent_V1::GeneratedPhysMaterial' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, DefaultBodyInstance) == 0x000490, "Member 'UHoudiniAssetComponent_V1::DefaultBodyInstance' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedCollisionTraceFlag) == 0x0005F0, "Member 'UHoudiniAssetComponent_V1::GeneratedCollisionTraceFlag' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedLightMapResolution) == 0x0005F4, "Member 'UHoudiniAssetComponent_V1::GeneratedLightMapResolution' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedDistanceFieldResolutionScale) == 0x0005F8, "Member 'UHoudiniAssetComponent_V1::GeneratedDistanceFieldResolutionScale' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedWalkableSlopeOverride) == 0x0005FC, "Member 'UHoudiniAssetComponent_V1::GeneratedWalkableSlopeOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedLightMapCoordinateIndex) == 0x00060C, "Member 'UHoudiniAssetComponent_V1::GeneratedLightMapCoordinateIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedStreamingDistanceMultiplier) == 0x000614, "Member 'UHoudiniAssetComponent_V1::GeneratedStreamingDistanceMultiplier' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedFoliageDefaultSettings) == 0x000618, "Member 'UHoudiniAssetComponent_V1::GeneratedFoliageDefaultSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedAssetUserData) == 0x000620, "Member 'UHoudiniAssetComponent_V1::GeneratedAssetUserData' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, BakeFolder) == 0x000630, "Member 'UHoudiniAssetComponent_V1::BakeFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, TempCookFolder) == 0x000648, "Member 'UHoudiniAssetComponent_V1::TempCookFolder' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInput) == 0x000160, "Wrong size on UHoudiniInput");
...
static_assert(offsetof(UHoudiniInput, bExportLODs) == 0x000093, "Member 'UHoudiniInput::bExportLODs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bExportSockets) == 0x000094, "Member 'UHoudiniInput::bExportSockets' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bExportColliders) == 0x000095, "Member 'UHoudiniInput::bExportColliders' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bCookOnCurveChanged) == 0x000096, "Member 'UHoudiniInput::bCookOnCurveChanged' has a wrong offset!");
...
static_assert(offsetof(UHoudiniInput, LastInsertedInputs) == 0x000130, "Member 'UHoudiniInput::LastInsertedInputs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, LastUndoDeletedInputs) == 0x000140, "Member 'UHoudiniInput::LastUndoDeletedInputs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bUpdateInputLandscape) == 0x000150, "Member 'UHoudiniInput::bUpdateInputLandscape' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, LandscapeExportType) == 0x000151, "Member 'UHoudiniInput::LandscapeExportType' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportSelectionOnly) == 0x000152, "Member 'UHoudiniInput::bLandscapeExportSelectionOnly' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeAutoSelectComponent) == 0x000153, "Member 'UHoudiniInput::bLandscapeAutoSelectComponent' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportMaterials) == 0x000154, "Member 'UHoudiniInput::bLandscapeExportMaterials' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportLighting) == 0x000155, "Member 'UHoudiniInput::bLandscapeExportLighting' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportNormalizedUVs) == 0x000156, "Member 'UHoudiniInput::bLandscapeExportNormalizedUVs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportTileUVs) == 0x000157, "Member 'UHoudiniInput::bLandscapeExportTileUVs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bCanDeleteHoudiniNodes) == 0x000158, "Member 'UHoudiniInput::bCanDeleteHoudiniNodes' has a wrong offset!");
...
static_assert(offsetof(UHoudiniInputObject, bCanDeleteHoudiniNodes) == 0x0000B0, "Member 'UHoudiniInputObject::bCanDeleteHoudiniNodes' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_267[0x229];                                    // 0x0267(0x0229)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UHoudiniSplineComponent, bIsHoudiniSplineVisible) == 0x000262, "Member 'UHoudiniSplineComponent::bIsHoudiniSplineVisible' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveType) == 0x000263, "Member 'UHoudiniSplineComponent::CurveType' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveMethod) == 0x000264, "Member 'UHoudiniSplineComponent::CurveMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsOutputCurve) == 0x000265, "Member 'UHoudiniSplineComponent::bIsOutputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bCookOnCurveChanged) == 0x000266, "Member 'UHoudiniSplineComponent::bCookOnCurveChanged' has a wrong offset!");
...
static_assert(sizeof(UHoudiniStaticMeshComponent) == 0x000500, "Wrong size on UHoudiniStaticMeshComponent");
static_assert(offsetof(UHoudiniStaticMeshComponent, Mesh) == 0x0004D0, "Member 'UHoudiniStaticMeshComponent::Mesh' has a wrong offset!");
static_assert(offsetof(UHoudiniStaticMeshComponent, LocalBounds) == 0x0004D8, "Member 'UHoudiniStaticMeshComponent::LocalBounds' has a wrong offset!");
static_assert(offsetof(UHoudiniStaticMeshComponent, bHoudiniIconVisible) == 0x0004F4, "Member 'UHoudiniStaticMeshComponent::bHoudiniIconVisible' has a wrong offset!");
