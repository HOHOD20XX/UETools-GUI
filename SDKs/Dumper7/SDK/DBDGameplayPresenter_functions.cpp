...
void USurvivorStatusComponent::OnPlayerImmobilizeStateChanged(const ECamperImmobilizeState oldImmobilizeState, const ECamperImmobilizeState newImmobilizeState)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SurvivorStatusComponent", "OnPlayerImmobilizeStateChanged");

	Params::SurvivorStatusComponent_OnPlayerImmobilizeStateChanged Parms{};
...
// (Final, Native, Private)
// Parameters:
// const ECamperDamageState                oldDamageState                                         (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const ECamperDamageState                newDamageState                                         (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
