...
static_assert(offsetof(FPartyMemberRepData, PlatformUniqueId) == 0x0000B0, "Member 'FPartyMemberRepData::PlatformUniqueId' has a wrong offset!");
static_assert(offsetof(FPartyMemberRepData, PlatformSessionId) == 0x000108, "Member 'FPartyMemberRepData::PlatformSessionId' has a wrong offset!");
