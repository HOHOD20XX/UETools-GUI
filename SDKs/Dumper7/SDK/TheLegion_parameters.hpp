...
static_assert(sizeof(LegionSurvivorAnalyticsComponent_OnGameEventDispatched) == 0x000038, "Wrong size on LegionSurvivorAnalyticsComponent_OnGameEventDispatched");
...
// 0x0038 (0x0038 - 0x0000)
struct FrenzyComponent_OnGameEventDispatched final
{
public:
	struct FGameplayTag                           gameEventType;                                     // 0x0000(0x000C)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FrenzyComponent_OnGameEventDispatched) == 0x000008, "Wrong alignment on FrenzyComponent_OnGameEventDispatched");
static_assert(sizeof(FrenzyComponent_OnGameEventDispatched) == 0x000038, "Wrong size on FrenzyComponent_OnGameEventDispatched");
static_assert(offsetof(FrenzyComponent_OnGameEventDispatched, gameEventType) == 0x000000, "Member 'FrenzyComponent_OnGameEventDispatched::gameEventType' has a wrong offset!");
static_assert(offsetof(FrenzyComponent_OnGameEventDispatched, gameEventData) == 0x000010, "Member 'FrenzyComponent_OnGameEventDispatched::gameEventData' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct FrenzySlasherVault_OnSlasherSet final
{
public:
...
static_assert(alignof(FrenzySlasherVault_OnSlasherSet) == 0x000008, "Wrong alignment on FrenzySlasherVault_OnSlasherSet");
static_assert(sizeof(FrenzySlasherVault_OnSlasherSet) == 0x000008, "Wrong size on FrenzySlasherVault_OnSlasherSet");
static_assert(offsetof(FrenzySlasherVault_OnSlasherSet, slasher) == 0x000000, "Member 'FrenzySlasherVault_OnSlasherSet::slasher' has a wrong offset!");
