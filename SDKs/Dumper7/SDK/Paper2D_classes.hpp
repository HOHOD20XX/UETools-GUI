...
static_assert(sizeof(UPaperGroupedSpriteComponent) == 0x000500, "Wrong size on UPaperGroupedSpriteComponent");
static_assert(offsetof(UPaperGroupedSpriteComponent, InstanceMaterials) == 0x0004D0, "Member 'UPaperGroupedSpriteComponent::InstanceMaterials' has a wrong offset!");
static_assert(offsetof(UPaperGroupedSpriteComponent, PerInstanceSpriteData) == 0x0004E0, "Member 'UPaperGroupedSpriteComponent::PerInstanceSpriteData' has a wrong offset!");
...
static_assert(sizeof(APaperCharacter) == 0x0004E0, "Wrong size on APaperCharacter");
static_assert(offsetof(APaperCharacter, Sprite) == 0x0004D0, "Member 'APaperCharacter::Sprite' has a wrong offset!");
...
static_assert(sizeof(UPaperFlipbookComponent) == 0x000520, "Wrong size on UPaperFlipbookComponent");
static_assert(offsetof(UPaperFlipbookComponent, SourceFlipbook) == 0x0004D0, "Member 'UPaperFlipbookComponent::SourceFlipbook' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, Material) == 0x0004D8, "Member 'UPaperFlipbookComponent::Material' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, PlayRate) == 0x0004E0, "Member 'UPaperFlipbookComponent::PlayRate' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, AccumulatedTime) == 0x0004E8, "Member 'UPaperFlipbookComponent::AccumulatedTime' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, CachedFrameIndex) == 0x0004EC, "Member 'UPaperFlipbookComponent::CachedFrameIndex' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, SpriteColor) == 0x0004F0, "Member 'UPaperFlipbookComponent::SpriteColor' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, CachedBodySetup) == 0x000500, "Member 'UPaperFlipbookComponent::CachedBodySetup' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, OnFinishedPlaying) == 0x000508, "Member 'UPaperFlipbookComponent::OnFinishedPlaying' has a wrong offset!");
...
static_assert(sizeof(UPaperSpriteComponent) == 0x0004F0, "Wrong size on UPaperSpriteComponent");
static_assert(offsetof(UPaperSpriteComponent, SourceSprite) == 0x0004D0, "Member 'UPaperSpriteComponent::SourceSprite' has a wrong offset!");
static_assert(offsetof(UPaperSpriteComponent, MaterialOverride) == 0x0004D8, "Member 'UPaperSpriteComponent::MaterialOverride' has a wrong offset!");
static_assert(offsetof(UPaperSpriteComponent, SpriteColor) == 0x0004E0, "Member 'UPaperSpriteComponent::SpriteColor' has a wrong offset!");
...
public:
	...
	int32                                         RandomSeed;                                        // 0x0498(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         ReparamStepsPerSegment;                            // 0x04B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPaperTerrainComponent) == 0x0004E0, "Wrong size on UPaperTerrainComponent");
static_assert(offsetof(UPaperTerrainComponent, TerrainMaterial) == 0x000480, "Member 'UPaperTerrainComponent::TerrainMaterial' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, bClosedSpline) == 0x000488, "Member 'UPaperTerrainComponent::bClosedSpline' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, bFilledSpline) == 0x000489, "Member 'UPaperTerrainComponent::bFilledSpline' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, AssociatedSpline) == 0x000490, "Member 'UPaperTerrainComponent::AssociatedSpline' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, RandomSeed) == 0x000498, "Member 'UPaperTerrainComponent::RandomSeed' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, SegmentOverlapAmount) == 0x00049C, "Member 'UPaperTerrainComponent::SegmentOverlapAmount' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, TerrainColor) == 0x0004A0, "Member 'UPaperTerrainComponent::TerrainColor' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, ReparamStepsPerSegment) == 0x0004B0, "Member 'UPaperTerrainComponent::ReparamStepsPerSegment' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, SpriteCollisionDomain) == 0x0004B4, "Member 'UPaperTerrainComponent::SpriteCollisionDomain' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, CollisionThickness) == 0x0004B8, "Member 'UPaperTerrainComponent::CollisionThickness' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, CachedBodySetup) == 0x0004C0, "Member 'UPaperTerrainComponent::CachedBodySetup' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UPaperTileSet>           SelectedTileSet;                                   // 0x0058(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         HexSideLength;                                     // 0x00A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         LayerNameIndex;                                    // 0x00B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPaperTileMap) == 0x0000C0, "Wrong size on UPaperTileMap");
static_assert(offsetof(UPaperTileMap, Draft) == 0x000030, "Member 'UPaperTileMap::Draft' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, Licensed) == 0x000031, "Member 'UPaperTileMap::Licensed' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, MapWidth) == 0x000034, "Member 'UPaperTileMap::MapWidth' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, MapHeight) == 0x000038, "Member 'UPaperTileMap::MapHeight' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, TileWidth) == 0x00003C, "Member 'UPaperTileMap::TileWidth' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, TileHeight) == 0x000040, "Member 'UPaperTileMap::TileHeight' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, PixelsPerUnrealUnit) == 0x000044, "Member 'UPaperTileMap::PixelsPerUnrealUnit' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, SeparationPerTileX) == 0x000048, "Member 'UPaperTileMap::SeparationPerTileX' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, SeparationPerTileY) == 0x00004C, "Member 'UPaperTileMap::SeparationPerTileY' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, SeparationPerLayer) == 0x000050, "Member 'UPaperTileMap::SeparationPerLayer' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, SelectedTileSet) == 0x000058, "Member 'UPaperTileMap::SelectedTileSet' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, Material) == 0x000088, "Member 'UPaperTileMap::Material' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, TileLayers) == 0x000090, "Member 'UPaperTileMap::TileLayers' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, CollisionThickness) == 0x0000A0, "Member 'UPaperTileMap::CollisionThickness' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, SpriteCollisionDomain) == 0x0000A4, "Member 'UPaperTileMap::SpriteCollisionDomain' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, ProjectionMode) == 0x0000A5, "Member 'UPaperTileMap::ProjectionMode' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, HexSideLength) == 0x0000A8, "Member 'UPaperTileMap::HexSideLength' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, BodySetup) == 0x0000B0, "Member 'UPaperTileMap::BodySetup' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, LayerNameIndex) == 0x0000B8, "Member 'UPaperTileMap::LayerNameIndex' has a wrong offset!");
...
static_assert(sizeof(UPaperTileMapComponent) == 0x000520, "Wrong size on UPaperTileMapComponent");
static_assert(offsetof(UPaperTileMapComponent, MapWidth) == 0x0004D0, "Member 'UPaperTileMapComponent::MapWidth' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, MapHeight) == 0x0004D4, "Member 'UPaperTileMapComponent::MapHeight' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileWidth) == 0x0004D8, "Member 'UPaperTileMapComponent::TileWidth' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileHeight) == 0x0004DC, "Member 'UPaperTileMapComponent::TileHeight' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, DefaultLayerTileSet) == 0x0004E0, "Member 'UPaperTileMapComponent::DefaultLayerTileSet' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, Material) == 0x0004E8, "Member 'UPaperTileMapComponent::Material' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileLayers) == 0x0004F0, "Member 'UPaperTileMapComponent::TileLayers' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileMapColor) == 0x000500, "Member 'UPaperTileMapComponent::TileMapColor' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, UseSingleLayerIndex) == 0x000510, "Member 'UPaperTileMapComponent::UseSingleLayerIndex' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, bUseSingleLayer) == 0x000514, "Member 'UPaperTileMapComponent::bUseSingleLayer' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileMap) == 0x000518, "Member 'UPaperTileMapComponent::TileMap' has a wrong offset!");
