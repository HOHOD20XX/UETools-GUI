...
class BP_DBDGameInstance::UBP_DBDGameInstance_C final : public BP_DBDGameInstance_0::UBP_DBDGameInstance_C
{
public:
...
static_assert(sizeof(BP_DBDGameInstance::UBP_DBDGameInstance_C) == 0x000D00, "Wrong size on BP_DBDGameInstance::UBP_DBDGameInstance_C");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, UberGraphFrame) == 0x000A18, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_DataTables_AssetData) == 0x000A20, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_DataTables_AssetData' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_DataTables_CharacterDescriptionDB) == 0x000A30, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_DataTables_CharacterDescriptionDB' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_DataTables_CustomizationItemDB) == 0x000A40, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_DataTables_CustomizationItemDB' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_DataTables_ItemAddonDB) == 0x000A50, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_DataTables_ItemAddonDB' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_DataTables_ItemDB) == 0x000A60, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_DataTables_ItemDB' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_DataTables_OfferingDB) == 0x000A70, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_DataTables_OfferingDB' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_DataTables_PerkDB) == 0x000A80, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_DataTables_PerkDB' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Class_StartScreen) == 0x000A90, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Class_StartScreen' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Class_Lobby) == 0x000AA0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Class_Lobby' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_AssetRegistry) == 0x000AB0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_AssetRegistry' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Class_Gameplay) == 0x000AC0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Class_Gameplay' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Soft_StartScreen) == 0x000AD0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Soft_StartScreen' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Soft_Lobby) == 0x000AE0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Soft_Lobby' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Soft_Gameplay) == 0x000AF0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Soft_Gameplay' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Counter_StartScreen) == 0x000B00, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Counter_StartScreen' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Counter_Lobby) == 0x000B04, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Counter_Lobby' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CH_Blueprints_Counter_Gameplay) == 0x000B08, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CH_Blueprints_Counter_Gameplay' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, bAutoEnableCheatFlyingControls) == 0x000B0C, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::bAutoEnableCheatFlyingControls' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, bCheatFlyingControls) == 0x000B0D, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::bCheatFlyingControls' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, UETools_Protected_Widgets) == 0x000B10, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::UETools_Protected_Widgets' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, UETools_Toggled_Widgets) == 0x000B20, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::UETools_Toggled_Widgets' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, WBP_Debug_Stats_Reference) == 0x000B70, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::WBP_Debug_Stats_Reference' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, WBP_Levels_List_Reference) == 0x000B78, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::WBP_Levels_List_Reference' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, Level_Streaming_Manager_Reference) == 0x000B80, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::Level_Streaming_Manager_Reference' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, ToggleActors_Actors_Map) == 0x000B88, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::ToggleActors_Actors_Map' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, UETools_BlockingVolumesVisualizers) == 0x000B98, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::UETools_BlockingVolumesVisualizers' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, UETools_TriggerVolumesVisualizers) == 0x000BA8, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::UETools_TriggerVolumesVisualizers' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, UETools_ActorsBoundsVisualizers) == 0x000BB8, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::UETools_ActorsBoundsVisualizers' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, Original_Aspect_Ratio) == 0x000BC8, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::Original_Aspect_Ratio' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, bWasOriginalAspectRatioStoren) == 0x000BCC, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::bWasOriginalAspectRatioStoren' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, CameraDefaultFOV) == 0x000BD0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::CameraDefaultFOV' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, DEF_MWS_Speed) == 0x000C20, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::DEF_MWS_Speed' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, DEF_MWS_CharMoveComponent) == 0x000C28, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::DEF_MWS_CharMoveComponent' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, DEF_GRV_Scale) == 0x000C30, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::DEF_GRV_Scale' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, DEF_GRV_CharMoveComponent) == 0x000C38, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::DEF_GRV_CharMoveComponent' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, DEF_MAC_Value) == 0x000C40, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::DEF_MAC_Value' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, DEF_MAC_CharMoveComponent) == 0x000C48, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::DEF_MAC_CharMoveComponent' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, ViewActor_Original_Pawn_Reference) == 0x000C50, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::ViewActor_Original_Pawn_Reference' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, ViewActor_Actor_Controller) == 0x000C58, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::ViewActor_Actor_Controller' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, ControlActor_Original_Pawn_Reference) == 0x000C60, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::ControlActor_Original_Pawn_Reference' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, ControlActor_Actor_Controller) == 0x000C68, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::ControlActor_Actor_Controller' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, Sound2D_CurrentlyPlaying) == 0x000C70, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::Sound2D_CurrentlyPlaying' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, UETools_Console_Commands) == 0x000C78, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::UETools_Console_Commands' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, UETools_World_Grid_Material) == 0x000C88, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::UETools_World_Grid_Material' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, PlayersOnly_Paused_Pawns_Map) == 0x000C90, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::PlayersOnly_Paused_Pawns_Map' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, FreeCamera_Reference) == 0x000CE0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::FreeCamera_Reference' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, FreeCamera_Original_Pawn_Reference) == 0x000CE8, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::FreeCamera_Original_Pawn_Reference' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, Panorama_Camera_Reference) == 0x000CF0, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::Panorama_Camera_Reference' has a wrong offset!");
static_assert(offsetof(BP_DBDGameInstance::UBP_DBDGameInstance_C, Panorama_Camera_Original_Pawn_Reference) == 0x000CF8, "Member 'BP_DBDGameInstance::UBP_DBDGameInstance_C::Panorama_Camera_Original_Pawn_Reference' has a wrong offset!");
