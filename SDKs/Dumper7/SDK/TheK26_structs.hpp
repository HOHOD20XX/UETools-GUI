...
static_assert(sizeof(FK26PathData) == 0x000040, "Wrong size on FK26PathData");
...
static_assert(offsetof(FK26PathData, PathEndRotation) == 0x000034, "Member 'FK26PathData::PathEndRotation' has a wrong offset!");
