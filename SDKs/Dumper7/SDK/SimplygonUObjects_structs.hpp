...
static_assert(sizeof(FFlipbookSettings) == 0x000020, "Wrong size on FFlipbookSettings");
...
static_assert(offsetof(FFlipbookSettings, VerticalAngle) == 0x00001C, "Member 'FFlipbookSettings::VerticalAngle' has a wrong offset!");
