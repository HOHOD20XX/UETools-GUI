...
static_assert(sizeof(FK29GuidedMovementInstance) == 0x000050, "Wrong size on FK29GuidedMovementInstance");
...
static_assert(offsetof(FK29GuidedMovementInstance, StartingPosition) == 0x000004, "Member 'FK29GuidedMovementInstance::StartingPosition' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementInstance, EndingPosition) == 0x000010, "Member 'FK29GuidedMovementInstance::EndingPosition' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementInstance, ForwardDirection) == 0x00001C, "Member 'FK29GuidedMovementInstance::ForwardDirection' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementInstance, XYForwardDirection) == 0x000028, "Member 'FK29GuidedMovementInstance::XYForwardDirection' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementInstance, EndInImpact) == 0x000034, "Member 'FK29GuidedMovementInstance::EndInImpact' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementInstance, EndAtLedge) == 0x000035, "Member 'FK29GuidedMovementInstance::EndAtLedge' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementInstance, StartingTime) == 0x000038, "Member 'FK29GuidedMovementInstance::StartingTime' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementInstance, EndingTime) == 0x00003C, "Member 'FK29GuidedMovementInstance::EndingTime' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementInstance, MovementCurve) == 0x000040, "Member 'FK29GuidedMovementInstance::MovementCurve' has a wrong offset!");
...
static_assert(sizeof(FK29GuidedMovementSettings) == 0x000050, "Wrong size on FK29GuidedMovementSettings");
...
static_assert(offsetof(FK29GuidedMovementSettings, ForwardDirection) == 0x000014, "Member 'FK29GuidedMovementSettings::ForwardDirection' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementSettings, CapsuleHeight) == 0x000020, "Member 'FK29GuidedMovementSettings::CapsuleHeight' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementSettings, CapsuleCenterHeightOffset) == 0x000024, "Member 'FK29GuidedMovementSettings::CapsuleCenterHeightOffset' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementSettings, CapsuleRadius) == 0x000028, "Member 'FK29GuidedMovementSettings::CapsuleRadius' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementSettings, MinimumRequiredDistance) == 0x00002C, "Member 'FK29GuidedMovementSettings::MinimumRequiredDistance' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementSettings, MaximumDuration) == 0x000030, "Member 'FK29GuidedMovementSettings::MaximumDuration' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementSettings, MovementSpeedInCmPerSecond) == 0x000034, "Member 'FK29GuidedMovementSettings::MovementSpeedInCmPerSecond' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementSettings, IsCarryingSurvivor) == 0x000038, "Member 'FK29GuidedMovementSettings::IsCarryingSurvivor' has a wrong offset!");
static_assert(offsetof(FK29GuidedMovementSettings, IgnoredActors) == 0x000040, "Member 'FK29GuidedMovementSettings::IgnoredActors' has a wrong offset!");
