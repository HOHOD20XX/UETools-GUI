...
public:
	...
	class BP_DBDGameInstance::UBP_DBDGameInstance_C* Game_Instance_Reference;                        // 0x0250(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
