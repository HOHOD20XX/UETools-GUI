...
static_assert(alignof(DragDropOperation_DraggedVisual) == 0x000004, "Wrong alignment on DragDropOperation_DraggedVisual");
static_assert(sizeof(DragDropOperation_DraggedVisual) == 0x000010, "Wrong size on DragDropOperation_DraggedVisual");
static_assert(offsetof(DragDropOperation_DraggedVisual, DesiredPosition) == 0x000000, "Member 'DragDropOperation_DraggedVisual::DesiredPosition' has a wrong offset!");
static_assert(offsetof(DragDropOperation_DraggedVisual, DesiredSize) == 0x000008, "Member 'DragDropOperation_DraggedVisual::DesiredSize' has a wrong offset!");
