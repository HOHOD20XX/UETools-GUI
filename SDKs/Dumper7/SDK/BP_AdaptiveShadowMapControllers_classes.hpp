...
static_assert(sizeof(ABP_AdaptiveShadowMapControllers_C) == 0x000248, "Wrong size on ABP_AdaptiveShadowMapControllers_C");
static_assert(offsetof(ABP_AdaptiveShadowMapControllers_C, GMAdaptiveShadowMapControllerSpotlights) == 0x000230, "Member 'ABP_AdaptiveShadowMapControllers_C::GMAdaptiveShadowMapControllerSpotlights' has a wrong offset!");
static_assert(offsetof(ABP_AdaptiveShadowMapControllers_C, GMAdaptiveShadowMapControllerDirectional) == 0x000238, "Member 'ABP_AdaptiveShadowMapControllers_C::GMAdaptiveShadowMapControllerDirectional' has a wrong offset!");
static_assert(offsetof(ABP_AdaptiveShadowMapControllers_C, DefaultSceneRoot) == 0x000240, "Member 'ABP_AdaptiveShadowMapControllers_C::DefaultSceneRoot' has a wrong offset!");
