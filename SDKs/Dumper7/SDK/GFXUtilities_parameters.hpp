...
static_assert(alignof(BatchMeshCommands_SetVectorParameter) == 0x000004, "Wrong alignment on BatchMeshCommands_SetVectorParameter");
static_assert(sizeof(BatchMeshCommands_SetVectorParameter) == 0x000018, "Wrong size on BatchMeshCommands_SetVectorParameter");
...
static_assert(offsetof(BatchMeshCommands_SetVectorParameter, newValue) == 0x00000C, "Member 'BatchMeshCommands_SetVectorParameter::newValue' has a wrong offset!");
...
static_assert(offsetof(DBDReflectionCaptureSpawnerComponent_SetBrightness, brightness) == 0x000000, "Member 'DBDReflectionCaptureSpawnerComponent_SetBrightness::brightness' has a wrong offset!");
...
static_assert(offsetof(DBDReflectionCaptureSpawnerComponent_SetContributionFactor, contributionFactor) == 0x000000, "Member 'DBDReflectionCaptureSpawnerComponent_SetContributionFactor::contributionFactor' has a wrong offset!");
...
static_assert(offsetof(DBDReflectionCaptureSpawnerComponent_SetIBLMultiplicator, IBLMultiplicator_0) == 0x000000, "Member 'DBDReflectionCaptureSpawnerComponent_SetIBLMultiplicator::IBLMultiplicator_0' has a wrong offset!");
