...
{
public:
	TSoftObjectPtr<class UDataTable>              AssetPtr;                                          // 0x0000(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(FDataTableProxy, _dataTable) == 0x000030, "Member 'FDataTableProxy::_dataTable' has a wrong offset!");
