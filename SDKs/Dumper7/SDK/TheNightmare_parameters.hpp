...
static_assert(sizeof(GeneratorTeleportInteraction_Multicast_OnTeleportLocationChosen) == 0x000040, "Wrong size on GeneratorTeleportInteraction_Multicast_OnTeleportLocationChosen");
...
static_assert(alignof(GeneratorTeleportInteraction_Multicast_TeleportPlayer) == 0x000004, "Wrong alignment on GeneratorTeleportInteraction_Multicast_TeleportPlayer");
static_assert(sizeof(GeneratorTeleportInteraction_Multicast_TeleportPlayer) == 0x000018, "Wrong size on GeneratorTeleportInteraction_Multicast_TeleportPlayer");
...
static_assert(offsetof(GeneratorTeleportInteraction_Multicast_TeleportPlayer, rotation) == 0x00000C, "Member 'GeneratorTeleportInteraction_Multicast_TeleportPlayer::rotation' has a wrong offset!");
...
static_assert(sizeof(GeneratorTeleportInteraction_OnTeleported) == 0x000030, "Wrong size on GeneratorTeleportInteraction_OnTeleported");
...
static_assert(sizeof(GeneratorTeleportInteraction_OnTeleportLocationChosen) == 0x000040, "Wrong size on GeneratorTeleportInteraction_OnTeleportLocationChosen");
