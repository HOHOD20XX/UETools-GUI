...
struct Addon_K27Power_20_Client_OnAddonTriggered final
{
public:
...
static_assert(alignof(Addon_K27Power_20_Client_OnAddonTriggered) == 0x000001, "Wrong alignment on Addon_K27Power_20_Client_OnAddonTriggered");
static_assert(sizeof(Addon_K27Power_20_Client_OnAddonTriggered) == 0x000001, "Wrong size on Addon_K27Power_20_Client_OnAddonTriggered");
static_assert(offsetof(Addon_K27Power_20_Client_OnAddonTriggered, televisionsWerePowered) == 0x000000, "Member 'Addon_K27Power_20_Client_OnAddonTriggered::televisionsWerePowered' has a wrong offset!");

// Function TheOnryo.Addon_K27Power_20.Cosmetic_OnAddonTriggered
// 0x0010 (0x0010 - 0x0000)
struct Addon_K27Power_20_Cosmetic_OnAddonTriggered final
{
public:
	bool                                          televisionsWerePowered;                            // 0x0000(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(Addon_K27Power_20_Cosmetic_OnAddonTriggered) == 0x000008, "Wrong alignment on Addon_K27Power_20_Cosmetic_OnAddonTriggered");
static_assert(sizeof(Addon_K27Power_20_Cosmetic_OnAddonTriggered) == 0x000010, "Wrong size on Addon_K27Power_20_Cosmetic_OnAddonTriggered");
static_assert(offsetof(Addon_K27Power_20_Cosmetic_OnAddonTriggered, televisionsWerePowered) == 0x000000, "Member 'Addon_K27Power_20_Cosmetic_OnAddonTriggered::televisionsWerePowered' has a wrong offset!");
static_assert(offsetof(Addon_K27Power_20_Cosmetic_OnAddonTriggered, killer) == 0x000008, "Member 'Addon_K27Power_20_Cosmetic_OnAddonTriggered::killer' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct CondemnedComponent_OnKillerSet final
{
public:
...
static_assert(alignof(CondemnedComponent_OnKillerSet) == 0x000008, "Wrong alignment on CondemnedComponent_OnKillerSet");
static_assert(sizeof(CondemnedComponent_OnKillerSet) == 0x000008, "Wrong size on CondemnedComponent_OnKillerSet");
static_assert(offsetof(CondemnedComponent_OnKillerSet, killer) == 0x000000, "Member 'CondemnedComponent_OnKillerSet::killer' has a wrong offset!");
...
static_assert(sizeof(K27P01_Authority_OnSurvivorUnhookedOffScourgeHook) == 0x000028, "Wrong size on K27P01_Authority_OnSurvivorUnhookedOffScourgeHook");
...
{
public:
	const class AGenerator*                       triggeringGenerator;                               // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
