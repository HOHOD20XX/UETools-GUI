...
struct LShaderGameModeBP_C_ReceiveTick final
{
public:
	float                                         DeltaSeconds;                                      // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_LShaderGameModeBP_C_ReceiveTick;

// Function LShaderGameModeBP.LShaderGameModeBP_C.ExecuteUbergraph_LShaderGameModeBP
// 0x0020 (0x0020 - 0x0000)
struct LShaderGameModeBP_C_ExecuteUbergraph_LShaderGameModeBP final
{
public:
	...
	int32                                         CallFunc_GetShaderPrecompileRemainingCount_ReturnValue; // 0x0018(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LessEqual_IntInt_ReturnValue;             // 0x001C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
DUMPER7_ASSERTS_LShaderGameModeBP_C_ExecuteUbergraph_LShaderGameModeBP;
