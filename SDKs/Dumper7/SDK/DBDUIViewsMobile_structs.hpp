...
public:
	...
	TSoftObjectPtr<class UTexture2D>              StatusIcon;                                        // 0x0010(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFriendStatusUIData) == 0x000058, "Wrong size on FFriendStatusUIData");
...
static_assert(offsetof(FFriendStatusUIData, StatusText) == 0x000040, "Member 'FFriendStatusUIData::StatusText' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UPaperSprite>            DifficultyIcon;                                    // 0x0000(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMatchConfigDifficultyData) == 0x000008, "Wrong alignment on FMatchConfigDifficultyData");
static_assert(sizeof(FMatchConfigDifficultyData) == 0x000030, "Wrong size on FMatchConfigDifficultyData");
...
public:
	...
	TSoftObjectPtr<class UPaperSprite>            Icon;                                              // 0x0018(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMatchOptionAssetData) == 0x000008, "Wrong alignment on FMatchOptionAssetData");
static_assert(sizeof(FMatchOptionAssetData) == 0x000048, "Wrong size on FMatchOptionAssetData");
...
public:
	...
	TSoftObjectPtr<class UPaperSprite>            OptionIcon;                                        // 0x0030(0x0030)(Transient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMatchConfigOptionUIData) == 0x000068, "Wrong size on FMatchConfigOptionUIData");
...
static_assert(offsetof(FMatchConfigOptionUIData, OptionType) == 0x000060, "Member 'FMatchConfigOptionUIData::OptionType' has a wrong offset!");
...
{
public:
	TSoftClassPtr<class UClass>                   Widget;                                            // 0x0000(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UPaperSprite>            TabIcon;                                           // 0x0030(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<ECustomMatchOptions, int32>              DefaultOptionsID;                                  // 0x0060(0x0050)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMatchConfigTabData) == 0x000008, "Wrong alignment on FMatchConfigTabData");
static_assert(sizeof(FMatchConfigTabData) == 0x0000B0, "Wrong size on FMatchConfigTabData");
static_assert(offsetof(FMatchConfigTabData, Widget) == 0x000000, "Member 'FMatchConfigTabData::Widget' has a wrong offset!");
static_assert(offsetof(FMatchConfigTabData, TabIcon) == 0x000030, "Member 'FMatchConfigTabData::TabIcon' has a wrong offset!");
static_assert(offsetof(FMatchConfigTabData, DefaultOptionsID) == 0x000060, "Member 'FMatchConfigTabData::DefaultOptionsID' has a wrong offset!");
...
public:
	...
	TSoftClassPtr<class UClass>                   OptionButtonClass;                                 // 0x0010(0x0030)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCustomMatchTabConfig) == 0x000008, "Wrong alignment on FCustomMatchTabConfig");
static_assert(sizeof(FCustomMatchTabConfig) == 0x000040, "Wrong size on FCustomMatchTabConfig");
