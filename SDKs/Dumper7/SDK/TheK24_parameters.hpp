...
static_assert(sizeof(ZombieAIController_Authority_OnTargetPerceptionUpdated) == 0x000050, "Wrong size on ZombieAIController_Authority_OnTargetPerceptionUpdated");
...
struct ZombieAIController_OnSlasherSet final
{
public:
...
static_assert(alignof(ZombieAIController_OnSlasherSet) == 0x000008, "Wrong alignment on ZombieAIController_OnSlasherSet");
static_assert(sizeof(ZombieAIController_OnSlasherSet) == 0x000008, "Wrong size on ZombieAIController_OnSlasherSet");
static_assert(offsetof(ZombieAIController_OnSlasherSet, slasher) == 0x000000, "Member 'ZombieAIController_OnSlasherSet::slasher' has a wrong offset!");
...
static_assert(sizeof(BlastMine_Client_TrapActivatedLoudNotification) == 0x000030, "Wrong size on BlastMine_Client_TrapActivatedLoudNotification");
...
static_assert(sizeof(BlastMine_ThrowBubbleIndicator_Cosmetic) == 0x000030, "Wrong size on BlastMine_ThrowBubbleIndicator_Cosmetic");
...
// 0x0008 (0x0008 - 0x0000)
struct Eruption_MakeSurvivorScreamCosmetic final
{
public:
...
static_assert(alignof(Eruption_MakeSurvivorScreamCosmetic) == 0x000008, "Wrong alignment on Eruption_MakeSurvivorScreamCosmetic");
static_assert(sizeof(Eruption_MakeSurvivorScreamCosmetic) == 0x000008, "Wrong size on Eruption_MakeSurvivorScreamCosmetic");
static_assert(offsetof(Eruption_MakeSurvivorScreamCosmetic, screamingSurvivor) == 0x000000, "Member 'Eruption_MakeSurvivorScreamCosmetic::screamingSurvivor' has a wrong offset!");
...
// 0x0010 (0x0010 - 0x0000)
struct Eruption_Multicast_TriggerPerk final
{
public:
...
static_assert(alignof(Eruption_Multicast_TriggerPerk) == 0x000008, "Wrong alignment on Eruption_Multicast_TriggerPerk");
static_assert(sizeof(Eruption_Multicast_TriggerPerk) == 0x000010, "Wrong size on Eruption_Multicast_TriggerPerk");
static_assert(offsetof(Eruption_Multicast_TriggerPerk, explodingGenerators) == 0x000000, "Member 'Eruption_Multicast_TriggerPerk::explodingGenerators' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct InjectSerumInteraction_OnKillerSet final
{
public:
...
static_assert(alignof(InjectSerumInteraction_OnKillerSet) == 0x000008, "Wrong alignment on InjectSerumInteraction_OnKillerSet");
static_assert(sizeof(InjectSerumInteraction_OnKillerSet) == 0x000008, "Wrong size on InjectSerumInteraction_OnKillerSet");
static_assert(offsetof(InjectSerumInteraction_OnKillerSet, killer) == 0x000000, "Member 'InjectSerumInteraction_OnKillerSet::killer' has a wrong offset!");
...
static_assert(alignof(K24Power_PowerHitStateEnd_Cosmetic) == 0x000004, "Wrong alignment on K24Power_PowerHitStateEnd_Cosmetic");
static_assert(sizeof(K24Power_PowerHitStateEnd_Cosmetic) == 0x000018, "Wrong size on K24Power_PowerHitStateEnd_Cosmetic");
...
static_assert(offsetof(K24Power_PowerHitStateEnd_Cosmetic, whipEndLocation) == 0x00000C, "Member 'K24Power_PowerHitStateEnd_Cosmetic::whipEndLocation' has a wrong offset!");
...
static_assert(alignof(K24Power_WhipAttackHit_Cosmetic) == 0x000004, "Wrong alignment on K24Power_WhipAttackHit_Cosmetic");
static_assert(sizeof(K24Power_WhipAttackHit_Cosmetic) == 0x000044, "Wrong size on K24Power_WhipAttackHit_Cosmetic");
...
static_assert(offsetof(K24Power_WhipAttackHit_Cosmetic, impactPointLocation) == 0x00000C, "Member 'K24Power_WhipAttackHit_Cosmetic::impactPointLocation' has a wrong offset!");
static_assert(offsetof(K24Power_WhipAttackHit_Cosmetic, whipEndLocation) == 0x000018, "Member 'K24Power_WhipAttackHit_Cosmetic::whipEndLocation' has a wrong offset!");
static_assert(offsetof(K24Power_WhipAttackHit_Cosmetic, isFirstHit) == 0x000024, "Member 'K24Power_WhipAttackHit_Cosmetic::isFirstHit' has a wrong offset!");
static_assert(offsetof(K24Power_WhipAttackHit_Cosmetic, impactNormal) == 0x000028, "Member 'K24Power_WhipAttackHit_Cosmetic::impactNormal' has a wrong offset!");
static_assert(offsetof(K24Power_WhipAttackHit_Cosmetic, phyMaterial) == 0x000034, "Member 'K24Power_WhipAttackHit_Cosmetic::phyMaterial' has a wrong offset!");
static_assert(offsetof(K24Power_WhipAttackHit_Cosmetic, hitACharacter) == 0x000040, "Member 'K24Power_WhipAttackHit_Cosmetic::hitACharacter' has a wrong offset!");
...
static_assert(alignof(K24Power_WhipAttackMove_Cosmetic) == 0x000004, "Wrong alignment on K24Power_WhipAttackMove_Cosmetic");
static_assert(sizeof(K24Power_WhipAttackMove_Cosmetic) == 0x00001C, "Wrong size on K24Power_WhipAttackMove_Cosmetic");
...
static_assert(offsetof(K24Power_WhipAttackMove_Cosmetic, whipEndLocation) == 0x00000C, "Member 'K24Power_WhipAttackMove_Cosmetic::whipEndLocation' has a wrong offset!");
static_assert(offsetof(K24Power_WhipAttackMove_Cosmetic, isFirstRayCast) == 0x000018, "Member 'K24Power_WhipAttackMove_Cosmetic::isFirstRayCast' has a wrong offset!");
...
// 0x0010 (0x0010 - 0x0000)
struct ZombieCharacter_Authority_OnFirecrackerInRangeBegin final
{
public:
...
static_assert(alignof(ZombieCharacter_Authority_OnFirecrackerInRangeBegin) == 0x000008, "Wrong alignment on ZombieCharacter_Authority_OnFirecrackerInRangeBegin");
static_assert(sizeof(ZombieCharacter_Authority_OnFirecrackerInRangeBegin) == 0x000010, "Wrong size on ZombieCharacter_Authority_OnFirecrackerInRangeBegin");
static_assert(offsetof(ZombieCharacter_Authority_OnFirecrackerInRangeBegin, effectData) == 0x000000, "Member 'ZombieCharacter_Authority_OnFirecrackerInRangeBegin::effectData' has a wrong offset!");
...
{
public:
	const class UFlashlightComponent*             flashlight;                                        // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(ZombieCharacter_OnBeginOverlapZombieAttackDetector) == 0x0000B0, "Wrong size on ZombieCharacter_OnBeginOverlapZombieAttackDetector");
...
// 0x0008 (0x0008 - 0x0000)
struct ZombieCharacter_OnSlasherSet final
{
public:
	class ASlasherPlayer*                         slasher;                                           // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ZombieCharacter_OnSlasherSet) == 0x000008, "Wrong alignment on ZombieCharacter_OnSlasherSet");
static_assert(sizeof(ZombieCharacter_OnSlasherSet) == 0x000008, "Wrong size on ZombieCharacter_OnSlasherSet");
static_assert(offsetof(ZombieCharacter_OnSlasherSet, slasher) == 0x000000, "Member 'ZombieCharacter_OnSlasherSet::slasher' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct ZombieCustomizationComponent_Multicast_SetZombieCustomization final
{
public:
...
static_assert(alignof(ZombieCustomizationComponent_Multicast_SetZombieCustomization) == 0x000008, "Wrong alignment on ZombieCustomizationComponent_Multicast_SetZombieCustomization");
static_assert(sizeof(ZombieCustomizationComponent_Multicast_SetZombieCustomization) == 0x000008, "Wrong size on ZombieCustomizationComponent_Multicast_SetZombieCustomization");
static_assert(offsetof(ZombieCustomizationComponent_Multicast_SetZombieCustomization, survivor) == 0x000000, "Member 'ZombieCustomizationComponent_Multicast_SetZombieCustomization::survivor' has a wrong offset!");
...
static_assert(sizeof(ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered) == 0x000028, "Wrong size on ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered");
...
static_assert(offsetof(ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered, shouldTrack) == 0x00001C, "Member 'ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered::shouldTrack' has a wrong offset!");
static_assert(offsetof(ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered, audibleRange) == 0x000020, "Member 'ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered::audibleRange' has a wrong offset!");
static_assert(offsetof(ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered, isQuickAction) == 0x000024, "Member 'ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered::isQuickAction' has a wrong offset!");
static_assert(offsetof(ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered, isDeceivingNoise) == 0x000025, "Member 'ZombiesInterestEventManager_Authority_OnLoudNoiseTriggered::isDeceivingNoise' has a wrong offset!");
