...
static_assert(offsetof(UAnimSharingStateInstance, AnimationToPlay) == 0x0002C0, "Member 'UAnimSharingStateInstance::AnimationToPlay' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, PermutationTimeOffset) == 0x0002C8, "Member 'UAnimSharingStateInstance::PermutationTimeOffset' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, PlayRate) == 0x0002CC, "Member 'UAnimSharingStateInstance::PlayRate' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, bStateBool) == 0x0002D0, "Member 'UAnimSharingStateInstance::bStateBool' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, Instance) == 0x0002D8, "Member 'UAnimSharingStateInstance::Instance' has a wrong offset!");
...
static_assert(offsetof(UAnimSharingTransitionInstance, FromComponent) == 0x0002C0, "Member 'UAnimSharingTransitionInstance::FromComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, ToComponent) == 0x0002C8, "Member 'UAnimSharingTransitionInstance::ToComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, BlendTime) == 0x0002D0, "Member 'UAnimSharingTransitionInstance::BlendTime' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, bBlendBool) == 0x0002D4, "Member 'UAnimSharingTransitionInstance::bBlendBool' has a wrong offset!");
...
static_assert(offsetof(UAnimSharingAdditiveInstance, BaseComponent) == 0x0002C0, "Member 'UAnimSharingAdditiveInstance::BaseComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, AdditiveAnimation) == 0x0002C8, "Member 'UAnimSharingAdditiveInstance::AdditiveAnimation' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, Alpha) == 0x0002D0, "Member 'UAnimSharingAdditiveInstance::Alpha' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, bStateBool) == 0x0002D4, "Member 'UAnimSharingAdditiveInstance::bStateBool' has a wrong offset!");
