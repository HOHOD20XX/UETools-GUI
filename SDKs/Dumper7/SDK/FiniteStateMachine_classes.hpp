...
{
public:
	TSubclassOf<class UFSM_State>                 _defaultStateClass;                                // 0x00B8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFiniteStateMachine) == 0x0000E8, "Wrong size on UFiniteStateMachine");
static_assert(offsetof(UFiniteStateMachine, _defaultStateClass) == 0x0000B8, "Member 'UFiniteStateMachine::_defaultStateClass' has a wrong offset!");
static_assert(offsetof(UFiniteStateMachine, _currentState) == 0x0000C0, "Member 'UFiniteStateMachine::_currentState' has a wrong offset!");
static_assert(offsetof(UFiniteStateMachine, _currentStateMachineStatus) == 0x0000C8, "Member 'UFiniteStateMachine::_currentStateMachineStatus' has a wrong offset!");
static_assert(offsetof(UFiniteStateMachine, _stateMachineOwner) == 0x0000D0, "Member 'UFiniteStateMachine::_stateMachineOwner' has a wrong offset!");
static_assert(offsetof(UFiniteStateMachine, _stateInstances) == 0x0000D8, "Member 'UFiniteStateMachine::_stateInstances' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UFSM_State>                 _defaultChildStateClass;                           // 0x0040(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	TSubclassOf<class UFSM_State>                 _transitionStateClass;                             // 0x0048(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
