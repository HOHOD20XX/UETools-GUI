...
static_assert(sizeof(FLoadout) == 0x000050, "Wrong size on FLoadout");
static_assert(offsetof(FLoadout, offering) == 0x000000, "Member 'FLoadout::offering' has a wrong offset!");
static_assert(offsetof(FLoadout, item) == 0x00000C, "Member 'FLoadout::item' has a wrong offset!");
static_assert(offsetof(FLoadout, addon1) == 0x000018, "Member 'FLoadout::addon1' has a wrong offset!");
static_assert(offsetof(FLoadout, addon2) == 0x000024, "Member 'FLoadout::addon2' has a wrong offset!");
static_assert(offsetof(FLoadout, _perks) == 0x000030, "Member 'FLoadout::_perks' has a wrong offset!");
...
public:
	...
	uint8                                         _difficulty;                                       // 0x0002(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3[0x1];                                        // 0x0003(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         _characterIndex;                                   // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         _slotIndex;                                        // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FCustomGameBot) == 0x0000C0, "Wrong size on FCustomGameBot");
static_assert(offsetof(FCustomGameBot, _role) == 0x000001, "Member 'FCustomGameBot::_role' has a wrong offset!");
static_assert(offsetof(FCustomGameBot, _difficulty) == 0x000002, "Member 'FCustomGameBot::_difficulty' has a wrong offset!");
static_assert(offsetof(FCustomGameBot, _characterIndex) == 0x000004, "Member 'FCustomGameBot::_characterIndex' has a wrong offset!");
static_assert(offsetof(FCustomGameBot, _slotIndex) == 0x000008, "Member 'FCustomGameBot::_slotIndex' has a wrong offset!");
static_assert(offsetof(FCustomGameBot, _botGUID) == 0x000010, "Member 'FCustomGameBot::_botGUID' has a wrong offset!");
static_assert(offsetof(FCustomGameBot, _botName) == 0x000020, "Member 'FCustomGameBot::_botName' has a wrong offset!");
static_assert(offsetof(FCustomGameBot, _loadout) == 0x000030, "Member 'FCustomGameBot::_loadout' has a wrong offset!");
...
public:
	...
	int64                                         _disconnectionPenaltyEndOfBan;                     // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_E0[0x8];                                       // 0x00E0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSocialPartyMember) == 0x000008, "Wrong alignment on FSocialPartyMember");
static_assert(sizeof(FSocialPartyMember) == 0x0000E8, "Wrong size on FSocialPartyMember");
...
static_assert(offsetof(FSocialPartyMember, _disconnectionPenaltyEndOfBan) == 0x0000D8, "Member 'FSocialPartyMember::_disconnectionPenaltyEndOfBan' has a wrong offset!");
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<uint8>                                 _mapAvailabilities;                                // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FCustomGamePresetData, _mapAvailabilities) == 0x000008, "Member 'FCustomGamePresetData::_mapAvailabilities' has a wrong offset!");
static_assert(offsetof(FCustomGamePresetData, _arePerkAvailable) == 0x000018, "Member 'FCustomGamePresetData::_arePerkAvailable' has a wrong offset!");
static_assert(offsetof(FCustomGamePresetData, _areOfferingAvailable) == 0x000019, "Member 'FCustomGamePresetData::_areOfferingAvailable' has a wrong offset!");
static_assert(offsetof(FCustomGamePresetData, _areItemAvailable) == 0x00001A, "Member 'FCustomGamePresetData::_areItemAvailable' has a wrong offset!");
static_assert(offsetof(FCustomGamePresetData, _areItemAddonAvailable) == 0x00001B, "Member 'FCustomGamePresetData::_areItemAddonAvailable' has a wrong offset!");
static_assert(offsetof(FCustomGamePresetData, _areDlcContentAllowed) == 0x00001C, "Member 'FCustomGamePresetData::_areDlcContentAllowed' has a wrong offset!");
static_assert(offsetof(FCustomGamePresetData, _isPrivateMatch) == 0x00001D, "Member 'FCustomGamePresetData::_isPrivateMatch' has a wrong offset!");
static_assert(offsetof(FCustomGamePresetData, _botsData) == 0x000020, "Member 'FCustomGamePresetData::_botsData' has a wrong offset!");
