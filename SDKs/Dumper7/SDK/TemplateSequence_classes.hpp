...
public:
	...
	uint8                                         Pad_644[0x4C];                                     // 0x0644(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentFocalLength) == 0x000638, "Member 'USequenceCameraShakeCameraStandIn::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentAperture) == 0x00063C, "Member 'USequenceCameraShakeCameraStandIn::CurrentAperture' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentFocusDistance) == 0x000640, "Member 'USequenceCameraShakeCameraStandIn::CurrentFocusDistance' has a wrong offset!");
