...
public:
	...
	TSoftClassPtr<class UClass>                   KillerSpecificSurvivorAnimation;                   // 0x0018(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FKillerSpecificSurvivorAnimationsRow) == 0x000048, "Wrong size on FKillerSpecificSurvivorAnimationsRow");
