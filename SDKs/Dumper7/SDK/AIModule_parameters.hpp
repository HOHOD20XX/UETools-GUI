...
static_assert(alignof(AISense_Hearing_Authority_ReportNoiseEventBHVR) == 0x000008, "Wrong alignment on AISense_Hearing_Authority_ReportNoiseEventBHVR");
static_assert(sizeof(AISense_Hearing_Authority_ReportNoiseEventBHVR) == 0x000030, "Wrong size on AISense_Hearing_Authority_ReportNoiseEventBHVR");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, InstigatingActor) == 0x000000, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::InstigatingActor' has a wrong offset!");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, NoiseLocation) == 0x000008, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::NoiseLocation' has a wrong offset!");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, Loudness) == 0x000014, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::Loudness' has a wrong offset!");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, Instigator) == 0x000018, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::Instigator' has a wrong offset!");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, MaxRange) == 0x000020, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::MaxRange' has a wrong offset!");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, Tag) == 0x000024, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::Tag' has a wrong offset!");
