...
static_assert(sizeof(UAudioCurveSourceComponent) == 0x0008D0, "Wrong size on UAudioCurveSourceComponent");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSourceBindingName) == 0x000890, "Member 'UAudioCurveSourceComponent::CurveSourceBindingName' has a wrong offset!");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSyncOffset) == 0x00089C, "Member 'UAudioCurveSourceComponent::CurveSyncOffset' has a wrong offset!");
