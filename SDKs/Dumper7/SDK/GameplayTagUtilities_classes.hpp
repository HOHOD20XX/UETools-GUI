...
static_assert(sizeof(UGameplayTagContainerComponent) == 0x0001D0, "Wrong size on UGameplayTagContainerComponent");
static_assert(offsetof(UGameplayTagContainerComponent, _tagToQueries) == 0x000130, "Member 'UGameplayTagContainerComponent::_tagToQueries' has a wrong offset!");
static_assert(offsetof(UGameplayTagContainerComponent, _ownerToQueries) == 0x000180, "Member 'UGameplayTagContainerComponent::_ownerToQueries' has a wrong offset!");
...
static_assert(alignof(IObjectStateProvider) == 0x000001, "Wrong alignment on IObjectStateProvider");
static_assert(sizeof(IObjectStateProvider) == 0x000001, "Wrong size on IObjectStateProvider");
