...
public:
	...
	TSoftObjectPtr<class UTexture2D>              Icon;                                              // 0x0090(0x0030)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         DefaultCharacterId;                                // 0x00C0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FOnboardingTutorialDefinition) == 0x0000C8, "Wrong size on FOnboardingTutorialDefinition");
...
static_assert(offsetof(FOnboardingTutorialDefinition, DefaultCharacterId) == 0x0000C0, "Member 'FOnboardingTutorialDefinition::DefaultCharacterId' has a wrong offset!");
...
static_assert(sizeof(FSecretBotMatchNamesDefinition) == 0x000020, "Wrong size on FSecretBotMatchNamesDefinition");
