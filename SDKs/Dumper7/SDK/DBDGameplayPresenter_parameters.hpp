...
struct SurvivorStatusComponent_OnPlayerImmobilizeStateChanged final
{
public:
...
static_assert(alignof(SurvivorStatusComponent_OnPlayerImmobilizeStateChanged) == 0x000001, "Wrong alignment on SurvivorStatusComponent_OnPlayerImmobilizeStateChanged");
static_assert(sizeof(SurvivorStatusComponent_OnPlayerImmobilizeStateChanged) == 0x000002, "Wrong size on SurvivorStatusComponent_OnPlayerImmobilizeStateChanged");
static_assert(offsetof(SurvivorStatusComponent_OnPlayerImmobilizeStateChanged, oldImmobilizeState) == 0x000000, "Member 'SurvivorStatusComponent_OnPlayerImmobilizeStateChanged::oldImmobilizeState' has a wrong offset!");
static_assert(offsetof(SurvivorStatusComponent_OnPlayerImmobilizeStateChanged, newImmobilizeState) == 0x000001, "Member 'SurvivorStatusComponent_OnPlayerImmobilizeStateChanged::newImmobilizeState' has a wrong offset!");
