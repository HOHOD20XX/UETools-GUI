...
static_assert(alignof(ITestInterface) == 0x000001, "Wrong alignment on ITestInterface");
static_assert(sizeof(ITestInterface) == 0x000001, "Wrong size on ITestInterface");
...
static_assert(sizeof(ATestActor) == 0x000230, "Wrong size on ATestActor");
...
static_assert(sizeof(UTestActorComponent) == 0x0000B8, "Wrong size on UTestActorComponent");
...
static_assert(sizeof(UTestActorComponentImplementingTestInterface) == 0x0000C0, "Wrong size on UTestActorComponentImplementingTestInterface");
...
static_assert(sizeof(ATestActorImplementingTestInterface) == 0x000238, "Wrong size on ATestActorImplementingTestInterface");
...
static_assert(sizeof(ATestMovableActor) == 0x000238, "Wrong size on ATestMovableActor");
static_assert(offsetof(ATestMovableActor, BoxComponent) == 0x000230, "Member 'ATestMovableActor::BoxComponent' has a wrong offset!");
