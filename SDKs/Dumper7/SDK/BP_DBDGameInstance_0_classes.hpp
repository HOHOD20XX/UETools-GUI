...
class BP_DBDGameInstance_0::UBP_DBDGameInstance_C : public UDBDGameInstance
{
public:
...
static_assert(sizeof(BP_DBDGameInstance_0::UBP_DBDGameInstance_C) == 0x000A18, "Wrong size on BP_DBDGameInstance_0::UBP_DBDGameInstance_C");
