...
static_assert(alignof(UGeneralProjectChunkingSettings) == 0x000008, "Wrong alignment on UGeneralProjectChunkingSettings");
static_assert(sizeof(UGeneralProjectChunkingSettings) == 0x0000F0, "Wrong size on UGeneralProjectChunkingSettings");
static_assert(offsetof(UGeneralProjectChunkingSettings, NumberOfPaksInInitialChunk) == 0x000030, "Member 'UGeneralProjectChunkingSettings::NumberOfPaksInInitialChunk' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, NumberOfPaksInAllChunks) == 0x000034, "Member 'UGeneralProjectChunkingSettings::NumberOfPaksInAllChunks' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, LeftoverPakId) == 0x000038, "Member 'UGeneralProjectChunkingSettings::LeftoverPakId' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, PakAssignmentPaths) == 0x000040, "Member 'UGeneralProjectChunkingSettings::PakAssignmentPaths' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, PakDefinitions) == 0x000050, "Member 'UGeneralProjectChunkingSettings::PakDefinitions' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, AtlantaNumberOfPaksInInitialChunk) == 0x000060, "Member 'UGeneralProjectChunkingSettings::AtlantaNumberOfPaksInInitialChunk' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, AtlantaAndroidNumberOfPaksInAllChunks) == 0x000064, "Member 'UGeneralProjectChunkingSettings::AtlantaAndroidNumberOfPaksInAllChunks' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, AtlantaIOSNumberOfPaksInAllChunks) == 0x000068, "Member 'UGeneralProjectChunkingSettings::AtlantaIOSNumberOfPaksInAllChunks' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, AtlantaLeftoverPakId) == 0x00006C, "Member 'UGeneralProjectChunkingSettings::AtlantaLeftoverPakId' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, AtlantaPakAssignmentPaths) == 0x000070, "Member 'UGeneralProjectChunkingSettings::AtlantaPakAssignmentPaths' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, AtlantaAndroidPakAssignmentPaths) == 0x000080, "Member 'UGeneralProjectChunkingSettings::AtlantaAndroidPakAssignmentPaths' has a wrong offset!");
static_assert(offsetof(UGeneralProjectChunkingSettings, AtlantaIOSPakAssignmentPaths) == 0x000090, "Member 'UGeneralProjectChunkingSettings::AtlantaIOSPakAssignmentPaths' has a wrong offset!");
