...
static_assert(sizeof(FK25SurvivorChainAttachmentData) == 0x000028, "Wrong size on FK25SurvivorChainAttachmentData");
...
static_assert(offsetof(FK25SurvivorChainAttachmentData, IsFlexibleLimb) == 0x00001C, "Member 'FK25SurvivorChainAttachmentData::IsFlexibleLimb' has a wrong offset!");
static_assert(offsetof(FK25SurvivorChainAttachmentData, LimbType) == 0x00001D, "Member 'FK25SurvivorChainAttachmentData::LimbType' has a wrong offset!");
static_assert(offsetof(FK25SurvivorChainAttachmentData, _attachedSurvivor) == 0x000020, "Member 'FK25SurvivorChainAttachmentData::_attachedSurvivor' has a wrong offset!");
...
static_assert(sizeof(FLamentConfigurationPlayerPossessionAnalytics) == 0x0000D0, "Wrong size on FLamentConfigurationPlayerPossessionAnalytics");
static_assert(offsetof(FLamentConfigurationPlayerPossessionAnalytics, MatchId) == 0x0000A8, "Member 'FLamentConfigurationPlayerPossessionAnalytics::MatchId' has a wrong offset!");
static_assert(offsetof(FLamentConfigurationPlayerPossessionAnalytics, PickUpElapsedMatchTime) == 0x0000B8, "Member 'FLamentConfigurationPlayerPossessionAnalytics::PickUpElapsedMatchTime' has a wrong offset!");
static_assert(offsetof(FLamentConfigurationPlayerPossessionAnalytics, DropElapsedMatchTime) == 0x0000BC, "Member 'FLamentConfigurationPlayerPossessionAnalytics::DropElapsedMatchTime' has a wrong offset!");
static_assert(offsetof(FLamentConfigurationPlayerPossessionAnalytics, Outcome) == 0x0000C0, "Member 'FLamentConfigurationPlayerPossessionAnalytics::Outcome' has a wrong offset!");
...
static_assert(alignof(FLamentConfigurationSpawnInfo) == 0x000004, "Wrong alignment on FLamentConfigurationSpawnInfo");
static_assert(sizeof(FLamentConfigurationSpawnInfo) == 0x000010, "Wrong size on FLamentConfigurationSpawnInfo");
static_assert(offsetof(FLamentConfigurationSpawnInfo, _worldLocation) == 0x000004, "Member 'FLamentConfigurationSpawnInfo::_worldLocation' has a wrong offset!");
