...
static_assert(sizeof(FRankGlobalData) == 0x000020, "Wrong size on FRankGlobalData");
...
static_assert(offsetof(FRankGlobalData, RankResetDates) == 0x000010, "Member 'FRankGlobalData::RankResetDates' has a wrong offset!");
...
static_assert(sizeof(FRankDefinitionData) == 0x000068, "Wrong size on FRankDefinitionData");
