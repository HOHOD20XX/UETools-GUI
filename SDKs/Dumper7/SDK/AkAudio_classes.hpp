...
static_assert(sizeof(AAkAcousticPortal) == 0x000278, "Wrong size on AAkAcousticPortal");
static_assert(offsetof(AAkAcousticPortal, Portal) == 0x000268, "Member 'AAkAcousticPortal::Portal' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, InitialState) == 0x000270, "Member 'AAkAcousticPortal::InitialState' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, bRequiresStateMigration) == 0x000271, "Member 'AAkAcousticPortal::bRequiresStateMigration' has a wrong offset!");
...
{
public:
	bool                                          bUseSpatialAudio;                                  // 0x0238(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         EnableSpotReflectors : 1;                          // 0x0244(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         Pad_2A1[0x16F];                                    // 0x02A1(0x016F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_419[0xF];                                      // 0x0419(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class UAkComponent*>                     ListenersInRange;                                  // 0x0428(0x0050)(ExportObject, Transient, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkComponent, OcclusionCollisionChannel) == 0x000240, "Member 'UAkComponent::OcclusionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkComponent, outerRadius) == 0x000248, "Member 'UAkComponent::outerRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, innerRadius) == 0x00024C, "Member 'UAkComponent::innerRadius' has a wrong offset!");
...
static_assert(offsetof(UAkComponent, OcclusionAffect) == 0x000298, "Member 'UAkComponent::OcclusionAffect' has a wrong offset!");
static_assert(offsetof(UAkComponent, MaxDistance) == 0x00029C, "Member 'UAkComponent::MaxDistance' has a wrong offset!");
static_assert(offsetof(UAkComponent, AutoPostOnBeginPlay) == 0x0002A0, "Member 'UAkComponent::AutoPostOnBeginPlay' has a wrong offset!");
static_assert(offsetof(UAkComponent, StaticAmbientEmitter) == 0x000410, "Member 'UAkComponent::StaticAmbientEmitter' has a wrong offset!");
static_assert(offsetof(UAkComponent, StaticAmbientEmitterFadeDuration) == 0x000414, "Member 'UAkComponent::StaticAmbientEmitterFadeDuration' has a wrong offset!");
static_assert(offsetof(UAkComponent, StaticAmbientEmitterInterpolationCurve) == 0x000418, "Member 'UAkComponent::StaticAmbientEmitterInterpolationCurve' has a wrong offset!");
static_assert(offsetof(UAkComponent, ListenersInRange) == 0x000428, "Member 'UAkComponent::ListenersInRange' has a wrong offset!");
...
// 0x0A18 (0x0B60 - 0x0148)
class UAkCheckBox final : public UContentWidget
{
public:
	uint8                                         Pad_148[0x348];                                    // 0x0148(0x0348)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TDelegate<void()>                             CheckedStateDelegate;                              // 0x0494(0x0014)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void(bool bIsChecked)> AkOnCheckStateChanged;                           // 0x0AE0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FGuid& ItemDroppedID)> OnItemDropped;                 // 0x0AF0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& PropertyDropped)> OnPropertyDropped;          // 0x0B00(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_B10[0x50];                                     // 0x0B10(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkCheckBox) == 0x000B60, "Wrong size on UAkCheckBox");
static_assert(offsetof(UAkCheckBox, CheckedState) == 0x000490, "Member 'UAkCheckBox::CheckedState' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, CheckedStateDelegate) == 0x000494, "Member 'UAkCheckBox::CheckedStateDelegate' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, WidgetStyle) == 0x0004A8, "Member 'UAkCheckBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, HorizontalAlignment) == 0x000A88, "Member 'UAkCheckBox::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, IsFocusable) == 0x000A89, "Member 'UAkCheckBox::IsFocusable' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, ThePropertyToControl) == 0x000A90, "Member 'UAkCheckBox::ThePropertyToControl' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, ItemToControl) == 0x000AA0, "Member 'UAkCheckBox::ItemToControl' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, AkOnCheckStateChanged) == 0x000AE0, "Member 'UAkCheckBox::AkOnCheckStateChanged' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, OnItemDropped) == 0x000AF0, "Member 'UAkCheckBox::OnItemDropped' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, OnPropertyDropped) == 0x000B00, "Member 'UAkCheckBox::OnPropertyDropped' has a wrong offset!");
...
public:
	...
	uint8                                         bEnableDiffraction : 1;                            // 0x02A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableDiffractionOnBoundaryEdges : 1;             // 0x02A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	...
	bool                                          bDynamic;                                          // 0x023C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkRoomComponent, bDynamic) == 0x00023C, "Member 'UAkRoomComponent::bDynamic' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, Priority) == 0x000240, "Member 'UAkRoomComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, WallOcclusion) == 0x000244, "Member 'UAkRoomComponent::WallOcclusion' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AuxSendLevel) == 0x000248, "Member 'UAkRoomComponent::AuxSendLevel' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AutoPost) == 0x00024C, "Member 'UAkRoomComponent::AutoPost' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_6E[0x1];                                       // 0x006E(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	TMulticastInlineDelegate<void(const struct FGuid& ItemDroppedID)> OnItemDropped;                 // 0x0548(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& PropertyDropped)> OnPropertyDropped;          // 0x0558(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkSlider) == 0x000588, "Wrong size on UAkSlider");
...
static_assert(offsetof(UAkSlider, WidgetStyle) == 0x000148, "Member 'UAkSlider::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UAkSlider, Orientation) == 0x0004B8, "Member 'UAkSlider::Orientation' has a wrong offset!");
static_assert(offsetof(UAkSlider, SliderBarColor) == 0x0004BC, "Member 'UAkSlider::SliderBarColor' has a wrong offset!");
static_assert(offsetof(UAkSlider, SliderHandleColor) == 0x0004CC, "Member 'UAkSlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(UAkSlider, IndentHandle) == 0x0004DC, "Member 'UAkSlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(UAkSlider, Locked) == 0x0004DD, "Member 'UAkSlider::Locked' has a wrong offset!");
static_assert(offsetof(UAkSlider, StepSize) == 0x0004E0, "Member 'UAkSlider::StepSize' has a wrong offset!");
static_assert(offsetof(UAkSlider, IsFocusable) == 0x0004E4, "Member 'UAkSlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(UAkSlider, ThePropertyToControl) == 0x0004E8, "Member 'UAkSlider::ThePropertyToControl' has a wrong offset!");
static_assert(offsetof(UAkSlider, ItemToControl) == 0x0004F8, "Member 'UAkSlider::ItemToControl' has a wrong offset!");
static_assert(offsetof(UAkSlider, OnValueChanged) == 0x000538, "Member 'UAkSlider::OnValueChanged' has a wrong offset!");
static_assert(offsetof(UAkSlider, OnItemDropped) == 0x000548, "Member 'UAkSlider::OnItemDropped' has a wrong offset!");
static_assert(offsetof(UAkSlider, OnPropertyDropped) == 0x000558, "Member 'UAkSlider::OnPropertyDropped' has a wrong offset!");
...
static_assert(offsetof(UAkSubmixInputComponent, SubmixToRecord) == 0x0004B0, "Member 'UAkSubmixInputComponent::SubmixToRecord' has a wrong offset!");
...
{
public:
	uint8                                         bEnableSurfaceReflectors : 1;                      // 0x0230(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         bEnableDiffraction : 1;                            // 0x0248(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableDiffractionOnBoundaryEdges : 1;             // 0x0248(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
