...
static_assert(sizeof(UAxisFlickMasher) == 0x0000F8, "Wrong size on UAxisFlickMasher");
static_assert(offsetof(UAxisFlickMasher, _inputComponent) == 0x0000B8, "Member 'UAxisFlickMasher::_inputComponent' has a wrong offset!");
static_assert(offsetof(UAxisFlickMasher, _axisFlick1) == 0x0000C8, "Member 'UAxisFlickMasher::_axisFlick1' has a wrong offset!");
static_assert(offsetof(UAxisFlickMasher, _axisFlick2) == 0x0000D0, "Member 'UAxisFlickMasher::_axisFlick2' has a wrong offset!");
...
static_assert(sizeof(UButtonPressTracker) == 0x000088, "Wrong size on UButtonPressTracker");
...
static_assert(sizeof(UInputMasher) == 0x0000F0, "Wrong size on UInputMasher");
static_assert(offsetof(UInputMasher, _inputComponent) == 0x0000B8, "Member 'UInputMasher::_inputComponent' has a wrong offset!");
