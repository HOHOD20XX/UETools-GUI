...
// Parameters:
// const class AConjoinedTwin*             ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// const class AActor*                     objectActor                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class ACamperPlayer*              interactingCamperPlayer                                (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UTwinAttachmentComponent::OnImmobilizedStateChanged(const ECamperImmobilizeState oldImmobilizeState, const ECamperImmobilizeState newImmobilizeState)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("TwinAttachmentComponent", "OnImmobilizedStateChanged");

	Params::TwinAttachmentComponent_OnImmobilizedStateChanged Parms{};
...
void UTwinJumpAttack::Client_Debug_PrintFinalDecisionOnScreen(bool foundPath)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("TwinJumpAttack", "Client_Debug_PrintFinalDecisionOnScreen");

	Params::TwinJumpAttack_Client_Debug_PrintFinalDecisionOnScreen Parms{};
