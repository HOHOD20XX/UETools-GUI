...
static_assert(sizeof(FBloodOrbInfo) == 0x000060, "Wrong size on FBloodOrbInfo");
static_assert(offsetof(FBloodOrbInfo, originalStaticMesh) == 0x000050, "Member 'FBloodOrbInfo::originalStaticMesh' has a wrong offset!");
static_assert(offsetof(FBloodOrbInfo, clonedStaticMesh) == 0x000058, "Member 'FBloodOrbInfo::clonedStaticMesh' has a wrong offset!");
