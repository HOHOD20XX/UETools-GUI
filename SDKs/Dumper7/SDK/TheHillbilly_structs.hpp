...
static_assert(sizeof(FChainsawAnalytics) == 0x0000C8, "Wrong size on FChainsawAnalytics");
static_assert(offsetof(FChainsawAnalytics, MatchId) == 0x0000A8, "Member 'FChainsawAnalytics::MatchId' has a wrong offset!");
static_assert(offsetof(FChainsawAnalytics, DownSurvivorsWithChainsawWhileCampingEvents) == 0x0000B8, "Member 'FChainsawAnalytics::DownSurvivorsWithChainsawWhileCampingEvents' has a wrong offset!");
...
static_assert(sizeof(FHillbillyAnalytics) == 0x000108, "Wrong size on FHillbillyAnalytics");
static_assert(offsetof(FHillbillyAnalytics, OverheatEvents) == 0x0000C8, "Member 'FHillbillyAnalytics::OverheatEvents' has a wrong offset!");
static_assert(offsetof(FHillbillyAnalytics, OverheatWhileSprintingEvents) == 0x0000D8, "Member 'FHillbillyAnalytics::OverheatWhileSprintingEvents' has a wrong offset!");
static_assert(offsetof(FHillbillyAnalytics, OverheatWhileCampingEvents) == 0x0000E8, "Member 'FHillbillyAnalytics::OverheatWhileCampingEvents' has a wrong offset!");
static_assert(offsetof(FHillbillyAnalytics, RevFromZeroHeatEvents) == 0x0000F8, "Member 'FHillbillyAnalytics::RevFromZeroHeatEvents' has a wrong offset!");
