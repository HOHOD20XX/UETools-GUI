...
static_assert(sizeof(ULunar2022EventComponent) == 0x0001C0, "Wrong size on ULunar2022EventComponent");
static_assert(offsetof(ULunar2022EventComponent, _eventTag) == 0x0000C8, "Member 'ULunar2022EventComponent::_eventTag' has a wrong offset!");
static_assert(offsetof(ULunar2022EventComponent, _redEnvelopes) == 0x0000D8, "Member 'ULunar2022EventComponent::_redEnvelopes' has a wrong offset!");
static_assert(offsetof(ULunar2022EventComponent, _scoreNormal) == 0x00019C, "Member 'ULunar2022EventComponent::_scoreNormal' has a wrong offset!");
static_assert(offsetof(ULunar2022EventComponent, _scoreJackpot) == 0x0001A8, "Member 'ULunar2022EventComponent::_scoreJackpot' has a wrong offset!");
static_assert(offsetof(ULunar2022EventComponent, _scoreOwner) == 0x0001B4, "Member 'ULunar2022EventComponent::_scoreOwner' has a wrong offset!");
...
static_assert(sizeof(ARedEnvelope) == 0x0003F8, "Wrong size on ARedEnvelope");
static_assert(offsetof(ARedEnvelope, _ownerPlayerState) == 0x000328, "Member 'ARedEnvelope::_ownerPlayerState' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeData) == 0x000338, "Member 'ARedEnvelope::_redEnvelopeData' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeInteraction) == 0x000358, "Member 'ARedEnvelope::_redEnvelopeInteraction' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeInteractionKiller) == 0x000360, "Member 'ARedEnvelope::_redEnvelopeInteractionKiller' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeInteractionChargeable) == 0x000368, "Member 'ARedEnvelope::_redEnvelopeInteractionChargeable' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeInteractionChargeableKiller) == 0x000370, "Member 'ARedEnvelope::_redEnvelopeInteractionChargeableKiller' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeInteractor) == 0x000378, "Member 'ARedEnvelope::_redEnvelopeInteractor' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeInteractionZone) == 0x000380, "Member 'ARedEnvelope::_redEnvelopeInteractionZone' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _outlineComponent) == 0x000388, "Member 'ARedEnvelope::_outlineComponent' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeMesh) == 0x000390, "Member 'ARedEnvelope::_redEnvelopeMesh' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeInteractionSecondsToCharge) == 0x000398, "Member 'ARedEnvelope::_redEnvelopeInteractionSecondsToCharge' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeInteractionSecondsToChargeKiller) == 0x0003C0, "Member 'ARedEnvelope::_redEnvelopeInteractionSecondsToChargeKiller' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _eventComponent) == 0x0003E8, "Member 'ARedEnvelope::_eventComponent' has a wrong offset!");
static_assert(offsetof(ARedEnvelope, _redEnvelopeOutlineUpdateStrategy) == 0x0003F0, "Member 'ARedEnvelope::_redEnvelopeOutlineUpdateStrategy' has a wrong offset!");
...
static_assert(sizeof(URedEnvelopeInteraction) == 0x0007A0, "Wrong size on URedEnvelopeInteraction");
...
static_assert(sizeof(URedEnvelopeOutlineUpdateStrategy) == 0x0000E0, "Wrong size on URedEnvelopeOutlineUpdateStrategy");
static_assert(offsetof(URedEnvelopeOutlineUpdateStrategy, _auraColorOwner) == 0x0000C0, "Member 'URedEnvelopeOutlineUpdateStrategy::_auraColorOwner' has a wrong offset!");
static_assert(offsetof(URedEnvelopeOutlineUpdateStrategy, _auraColorNonOwner) == 0x0000D0, "Member 'URedEnvelopeOutlineUpdateStrategy::_auraColorNonOwner' has a wrong offset!");
