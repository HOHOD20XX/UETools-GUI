...
static_assert(sizeof(UActiveDroneZoneLingeringEffect) == 0x000358, "Wrong size on UActiveDroneZoneLingeringEffect");
...
{
public:
	TSubclassOf<class UStatusEffect>              _modifySkillCheckDifficultyEffectClass;            // 0x02B8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAddon_K31Power_01) == 0x0002C8, "Wrong size on UAddon_K31Power_01");
static_assert(offsetof(UAddon_K31Power_01, _modifySkillCheckDifficultyEffectClass) == 0x0002B8, "Member 'UAddon_K31Power_01::_modifySkillCheckDifficultyEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_01, _skillCheckDifficultyModifier) == 0x0002C0, "Member 'UAddon_K31Power_01::_skillCheckDifficultyModifier' has a wrong offset!");
...
{
public:
	TSubclassOf<class UStatusEffect>              _blindnessEffectClass;                             // 0x02B8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAddon_K31Power_02) == 0x0002D0, "Wrong size on UAddon_K31Power_02");
static_assert(offsetof(UAddon_K31Power_02, _blindnessEffectClass) == 0x0002B8, "Member 'UAddon_K31Power_02::_blindnessEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_02, _blindnessEffectDuration) == 0x0002C0, "Member 'UAddon_K31Power_02::_blindnessEffectDuration' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_02, _blindnessEffect) == 0x0002C8, "Member 'UAddon_K31Power_02::_blindnessEffect' has a wrong offset!");
...
{
public:
	TSubclassOf<class UStatusEffect>              _actionSpeedEffect;                                // 0x02B8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UStatusEffect>              _hasteEffect;                                      // 0x02C0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAddon_K31Power_03) == 0x0002C8, "Wrong size on UAddon_K31Power_03");
static_assert(offsetof(UAddon_K31Power_03, _actionSpeedEffect) == 0x0002B8, "Member 'UAddon_K31Power_03::_actionSpeedEffect' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_03, _hasteEffect) == 0x0002C0, "Member 'UAddon_K31Power_03::_hasteEffect' has a wrong offset!");

// Class TheK31.Addon_K31Power_18
// 0x0008 (0x02C0 - 0x02B8)
class UAddon_K31Power_18 final : public UItemAddon
{
public:
...
static_assert(sizeof(UAddon_K31Power_18) == 0x0002C0, "Wrong size on UAddon_K31Power_18");
static_assert(offsetof(UAddon_K31Power_18, _batteryPercent) == 0x0002B8, "Member 'UAddon_K31Power_18::_batteryPercent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2C4[0x4];                                      // 0x02C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UStatusEffect>              _hasteEffectClass;                                 // 0x02C8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UAddon_K31Power_19, _playerZoneStatus) == 0x0002B8, "Member 'UAddon_K31Power_19::_playerZoneStatus' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_19, _hasteEffectPercentageMultiplier) == 0x0002C0, "Member 'UAddon_K31Power_19::_hasteEffectPercentageMultiplier' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_19, _hasteEffectClass) == 0x0002C8, "Member 'UAddon_K31Power_19::_hasteEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_19, _hasteEffect) == 0x0002D0, "Member 'UAddon_K31Power_19::_hasteEffect' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_19, _survivorActivatedDrones) == 0x0002D8, "Member 'UAddon_K31Power_19::_survivorActivatedDrones' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UStatusEffect>              _indicatorEffectClass;                             // 0x0310(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAddon_K31Power_20) == 0x000338, "Wrong size on UAddon_K31Power_20");
static_assert(offsetof(UAddon_K31Power_20, _terrorRadiusSize) == 0x0002B8, "Member 'UAddon_K31Power_20::_terrorRadiusSize' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _terrorRadiusDuration) == 0x0002BC, "Member 'UAddon_K31Power_20::_terrorRadiusDuration' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _allowedDroneStatesForEffectToApply) == 0x0002C0, "Member 'UAddon_K31Power_20::_allowedDroneStatesForEffectToApply' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _targetDrone) == 0x0002D0, "Member 'UAddon_K31Power_20::_targetDrone' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _terrorRadius) == 0x0002D8, "Member 'UAddon_K31Power_20::_terrorRadius' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _indicatorEffectClass) == 0x000310, "Member 'UAddon_K31Power_20::_indicatorEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _indicatorEffect) == 0x000318, "Member 'UAddon_K31Power_20::_indicatorEffect' has a wrong offset!");
...
{
public:
	bool                                          _shouldDeploymentSetPowerOnCooldown;               // 0x0618(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          _canPlaceDroneWhilePowerIsOnCooldown;              // 0x0619(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UDeployDroneInteraction) == 0x000630, "Wrong size on UDeployDroneInteraction");
static_assert(offsetof(UDeployDroneInteraction, _shouldDeploymentSetPowerOnCooldown) == 0x000618, "Member 'UDeployDroneInteraction::_shouldDeploymentSetPowerOnCooldown' has a wrong offset!");
static_assert(offsetof(UDeployDroneInteraction, _canPlaceDroneWhilePowerIsOnCooldown) == 0x000619, "Member 'UDeployDroneInteraction::_canPlaceDroneWhilePowerIsOnCooldown' has a wrong offset!");

// Class TheK31.DronePoolInitializer
// 0x0038 (0x00F0 - 0x00B8)
class UDronePoolInitializer final : public UActorComponent
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"DronePoolInitializer">();
	}
	static class UDronePoolInitializer* GetDefaultObj()
	{
		return GetDefaultObjImpl<UDronePoolInitializer>();
	}
};
static_assert(alignof(UDronePoolInitializer) == 0x000008, "Wrong alignment on UDronePoolInitializer");
static_assert(sizeof(UDronePoolInitializer) == 0x0000F0, "Wrong size on UDronePoolInitializer");
static_assert(offsetof(UDronePoolInitializer, _droneCount) == 0x0000B8, "Member 'UDronePoolInitializer::_droneCount' has a wrong offset!");
...
static_assert(sizeof(UDroneRestrictedPlacementAreaStrategy) == 0x0000B8, "Wrong size on UDroneRestrictedPlacementAreaStrategy");
...
static_assert(alignof(IHackableDroneState) == 0x000001, "Wrong alignment on IHackableDroneState");
static_assert(sizeof(IHackableDroneState) == 0x000001, "Wrong size on IHackableDroneState");
...
static_assert(sizeof(UHitPlayerInActiveZoneScoreEmitter) == 0x0000B0, "Wrong size on UHitPlayerInActiveZoneScoreEmitter");
...
public:
	...
	TSubclassOf<class UK31DroneActionProcessor>   _actionProcessorClass;                             // 0x0758(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoClear, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_798[0x20];                                     // 0x0798(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7C0[0xE0];                                     // 0x07C0(0x00E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInspectK31DroneInteraction) == 0x0008A0, "Wrong size on UInspectK31DroneInteraction");
static_assert(offsetof(UInspectK31DroneInteraction, _actionProcessorClass) == 0x000758, "Member 'UInspectK31DroneInteraction::_actionProcessorClass' has a wrong offset!");
static_assert(offsetof(UInspectK31DroneInteraction, _inputInterval) == 0x000760, "Member 'UInspectK31DroneInteraction::_inputInterval' has a wrong offset!");
static_assert(offsetof(UInspectK31DroneInteraction, _chargingSpeedCurve) == 0x000788, "Member 'UInspectK31DroneInteraction::_chargingSpeedCurve' has a wrong offset!");
static_assert(offsetof(UInspectK31DroneInteraction, _dechargingSpeedCurve) == 0x000790, "Member 'UInspectK31DroneInteraction::_dechargingSpeedCurve' has a wrong offset!");
static_assert(offsetof(UInspectK31DroneInteraction, _actionProcessor) == 0x0007B8, "Member 'UInspectK31DroneInteraction::_actionProcessor' has a wrong offset!");
...
static_assert(sizeof(UK31AnalyticsComponent) == 0x0000D8, "Wrong size on UK31AnalyticsComponent");
static_assert(offsetof(UK31AnalyticsComponent, _analyticInspectionTime) == 0x0000B8, "Member 'UK31AnalyticsComponent::_analyticInspectionTime' has a wrong offset!");
...
static_assert(sizeof(UK31AnimInstance) == 0x000640, "Wrong size on UK31AnimInstance");
static_assert(offsetof(UK31AnimInstance, _isInspecting) == 0x000600, "Member 'UK31AnimInstance::_isInspecting' has a wrong offset!");
static_assert(offsetof(UK31AnimInstance, _isDeployingADrone) == 0x000601, "Member 'UK31AnimInstance::_isDeployingADrone' has a wrong offset!");
static_assert(offsetof(UK31AnimInstance, _isReceivingADronePassively) == 0x000602, "Member 'UK31AnimInstance::_isReceivingADronePassively' has a wrong offset!");
static_assert(offsetof(UK31AnimInstance, _isRecallingADrone) == 0x000603, "Member 'UK31AnimInstance::_isRecallingADrone' has a wrong offset!");
static_assert(offsetof(UK31AnimInstance, _isActivatingADrone) == 0x000604, "Member 'UK31AnimInstance::_isActivatingADrone' has a wrong offset!");
static_assert(offsetof(UK31AnimInstance, _animationSelector) == 0x000608, "Member 'UK31AnimInstance::_animationSelector' has a wrong offset!");
...
static_assert(sizeof(AK31ClawTrap) == 0x000230, "Wrong size on AK31ClawTrap");
...
static_assert(sizeof(AK31Drone) == 0x000418, "Wrong size on AK31Drone");
static_assert(offsetof(AK31Drone, _movingRootComponent) == 0x000340, "Member 'AK31Drone::_movingRootComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _laserChildActorComponent) == 0x000348, "Member 'AK31Drone::_laserChildActorComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _laserController) == 0x000350, "Member 'AK31Drone::_laserController' has a wrong offset!");
static_assert(offsetof(AK31Drone, _droneMesh) == 0x000358, "Member 'AK31Drone::_droneMesh' has a wrong offset!");
static_assert(offsetof(AK31Drone, _activeZoneMesh) == 0x000360, "Member 'AK31Drone::_activeZoneMesh' has a wrong offset!");
static_assert(offsetof(AK31Drone, _movementComponent) == 0x000368, "Member 'AK31Drone::_movementComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _flightController) == 0x000370, "Member 'AK31Drone::_flightController' has a wrong offset!");
static_assert(offsetof(AK31Drone, _poolableActorComponent) == 0x000378, "Member 'AK31Drone::_poolableActorComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _ownershipComponent) == 0x000380, "Member 'AK31Drone::_ownershipComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _stateController) == 0x000388, "Member 'AK31Drone::_stateController' has a wrong offset!");
static_assert(offsetof(AK31Drone, _debugComponent) == 0x000390, "Member 'AK31Drone::_debugComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _droneZoneComponent) == 0x000398, "Member 'AK31Drone::_droneZoneComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _trapProximitySensor) == 0x0003A0, "Member 'AK31Drone::_trapProximitySensor' has a wrong offset!");
static_assert(offsetof(AK31Drone, _placementRecallerComponent) == 0x0003A8, "Member 'AK31Drone::_placementRecallerComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _objectState) == 0x0003B0, "Member 'AK31Drone::_objectState' has a wrong offset!");
static_assert(offsetof(AK31Drone, _hackableComponent) == 0x0003B8, "Member 'AK31Drone::_hackableComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _avoidanceSensor) == 0x0003C0, "Member 'AK31Drone::_avoidanceSensor' has a wrong offset!");
static_assert(offsetof(AK31Drone, _deployInteraction) == 0x0003C8, "Member 'AK31Drone::_deployInteraction' has a wrong offset!");
static_assert(offsetof(AK31Drone, _navModifierComponent) == 0x0003D0, "Member 'AK31Drone::_navModifierComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _dangerPredictionComponent) == 0x0003D8, "Member 'AK31Drone::_dangerPredictionComponent' has a wrong offset!");
static_assert(offsetof(AK31Drone, _lastOwner) == 0x0003E0, "Member 'AK31Drone::_lastOwner' has a wrong offset!");
static_assert(offsetof(AK31Drone, _localPlayerTracker) == 0x0003E8, "Member 'AK31Drone::_localPlayerTracker' has a wrong offset!");
...
static_assert(sizeof(UK31DroneActionProcessor) == 0x0000B8, "Wrong size on UK31DroneActionProcessor");
...
public:
	...
	uint8                                         Pad_3C0[0x48];                                     // 0x03C0(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UK31DroneActiveState) == 0x000408, "Wrong size on UK31DroneActiveState");
...
static_assert(sizeof(UK31DroneAnimInstance) == 0x0002E0, "Wrong size on UK31DroneAnimInstance");
static_assert(offsetof(UK31DroneAnimInstance, _droneState) == 0x0002C0, "Member 'UK31DroneAnimInstance::_droneState' has a wrong offset!");
static_assert(offsetof(UK31DroneAnimInstance, _droneStateController) == 0x0002C8, "Member 'UK31DroneAnimInstance::_droneStateController' has a wrong offset!");
static_assert(offsetof(UK31DroneAnimInstance, _owningDrone) == 0x0002D0, "Member 'UK31DroneAnimInstance::_owningDrone' has a wrong offset!");
...
static_assert(sizeof(UK31DroneDangerPredictionComponent) == 0x000128, "Wrong size on UK31DroneDangerPredictionComponent");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _minimumTraverseAngle) == 0x000108, "Member 'UK31DroneDangerPredictionComponent::_minimumTraverseAngle' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _maximumTraverseAngle) == 0x00010C, "Member 'UK31DroneDangerPredictionComponent::_maximumTraverseAngle' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _waitRangeMargin) == 0x000110, "Member 'UK31DroneDangerPredictionComponent::_waitRangeMargin' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _crouchingHeightDifference) == 0x000114, "Member 'UK31DroneDangerPredictionComponent::_crouchingHeightDifference' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _maxCrouchRange) == 0x000118, "Member 'UK31DroneDangerPredictionComponent::_maxCrouchRange' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _activeUnhackableWeight) == 0x00011C, "Member 'UK31DroneDangerPredictionComponent::_activeUnhackableWeight' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _activeHackableWeight) == 0x000120, "Member 'UK31DroneDangerPredictionComponent::_activeHackableWeight' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _scoutingWeight) == 0x000124, "Member 'UK31DroneDangerPredictionComponent::_scoutingWeight' has a wrong offset!");
...
static_assert(sizeof(UK31DroneFlightController) == 0x0000D0, "Wrong size on UK31DroneFlightController");
static_assert(offsetof(UK31DroneFlightController, _objectState) == 0x0000C8, "Member 'UK31DroneFlightController::_objectState' has a wrong offset!");
...
static_assert(sizeof(UK31DroneHackableAvoidanceSensor) == 0x000230, "Wrong size on UK31DroneHackableAvoidanceSensor");
static_assert(offsetof(UK31DroneHackableAvoidanceSensor, _survivorOverlapDetectionTime) == 0x000100, "Member 'UK31DroneHackableAvoidanceSensor::_survivorOverlapDetectionTime' has a wrong offset!");
static_assert(offsetof(UK31DroneHackableAvoidanceSensor, _killerDetectionPrimitive) == 0x000128, "Member 'UK31DroneHackableAvoidanceSensor::_killerDetectionPrimitive' has a wrong offset!");
static_assert(offsetof(UK31DroneHackableAvoidanceSensor, _survivorDetectionPrimitive) == 0x000130, "Member 'UK31DroneHackableAvoidanceSensor::_survivorDetectionPrimitive' has a wrong offset!");
static_assert(offsetof(UK31DroneHackableAvoidanceSensor, _overlappingSurvivors) == 0x000168, "Member 'UK31DroneHackableAvoidanceSensor::_overlappingSurvivors' has a wrong offset!");
static_assert(offsetof(UK31DroneHackableAvoidanceSensor, _overlappingKillerToVisibilityMap) == 0x0001C0, "Member 'UK31DroneHackableAvoidanceSensor::_overlappingKillerToVisibilityMap' has a wrong offset!");
...
static_assert(sizeof(UK31DroneHackableComponent) == 0x000138, "Wrong size on UK31DroneHackableComponent");
static_assert(offsetof(UK31DroneHackableComponent, _unhackableClearanceCooldownDuration) == 0x0000B8, "Member 'UK31DroneHackableComponent::_unhackableClearanceCooldownDuration' has a wrong offset!");
static_assert(offsetof(UK31DroneHackableComponent, _isHackable) == 0x0000E0, "Member 'UK31DroneHackableComponent::_isHackable' has a wrong offset!");
...
static_assert(sizeof(UK31DroneInitializingState) == 0x0000E8, "Wrong size on UK31DroneInitializingState");
...
static_assert(sizeof(UK31DroneInStashState) == 0x000068, "Wrong size on UK31DroneInStashState");
...
static_assert(sizeof(UK31DroneLaserController) == 0x0000F0, "Wrong size on UK31DroneLaserController");
static_assert(offsetof(UK31DroneLaserController, _localPlayerTracker) == 0x0000B8, "Member 'UK31DroneLaserController::_localPlayerTracker' has a wrong offset!");
static_assert(offsetof(UK31DroneLaserController, _locallyObservedPlayer) == 0x0000C0, "Member 'UK31DroneLaserController::_locallyObservedPlayer' has a wrong offset!");
static_assert(offsetof(UK31DroneLaserController, _laserActor) == 0x0000E8, "Member 'UK31DroneLaserController::_laserActor' has a wrong offset!");
...
static_assert(sizeof(AK31DroneLaserScanActor) == 0x000550, "Wrong size on AK31DroneLaserScanActor");
static_assert(offsetof(AK31DroneLaserScanActor, LaserScanMeshMaterial) == 0x000230, "Member 'AK31DroneLaserScanActor::LaserScanMeshMaterial' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, StaticCapturesLightAngle) == 0x000238, "Member 'AK31DroneLaserScanActor::StaticCapturesLightAngle' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, DynamicCapturesLightAngle) == 0x00023C, "Member 'AK31DroneLaserScanActor::DynamicCapturesLightAngle' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, DepthCaptureNearPlaneOffset) == 0x000240, "Member 'AK31DroneLaserScanActor::DepthCaptureNearPlaneOffset' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, FrontLaserScanSM) == 0x000248, "Member 'AK31DroneLaserScanActor::FrontLaserScanSM' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, BackLaserScanSM) == 0x000250, "Member 'AK31DroneLaserScanActor::BackLaserScanSM' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, FrontDepthCaptureComponentDynamic) == 0x000258, "Member 'AK31DroneLaserScanActor::FrontDepthCaptureComponentDynamic' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, BackDepthCaptureComponentDynamic) == 0x000260, "Member 'AK31DroneLaserScanActor::BackDepthCaptureComponentDynamic' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, XDepthCaptureComponentStatic) == 0x000268, "Member 'AK31DroneLaserScanActor::XDepthCaptureComponentStatic' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, YDepthCaptureComponentStatic) == 0x000270, "Member 'AK31DroneLaserScanActor::YDepthCaptureComponentStatic' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, NegXDepthCaptureComponentStatic) == 0x000278, "Member 'AK31DroneLaserScanActor::NegXDepthCaptureComponentStatic' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, NegYDepthCaptureComponentStatic) == 0x000280, "Member 'AK31DroneLaserScanActor::NegYDepthCaptureComponentStatic' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, DynamicDepthCaptureSizeWidth) == 0x000288, "Member 'AK31DroneLaserScanActor::DynamicDepthCaptureSizeWidth' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, DynamicDepthCaptureSizeHeight) == 0x000328, "Member 'AK31DroneLaserScanActor::DynamicDepthCaptureSizeHeight' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, StaticDepthCaptureSizeWidth) == 0x0003C8, "Member 'AK31DroneLaserScanActor::StaticDepthCaptureSizeWidth' has a wrong offset!");
static_assert(offsetof(AK31DroneLaserScanActor, StaticDepthCaptureSizeHeight) == 0x000468, "Member 'AK31DroneLaserScanActor::StaticDepthCaptureSizeHeight' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void()>              OnDeployLocationChangedEvent;                      // 0x0140(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnAttachToCharacterForDeployChangedEvent;          // 0x0150(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FVector& acceleration)> OnAccelerationChangedEvent;   // 0x0160(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnFlightHeightChangedBlueprintEvent;               // 0x0170(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnMovementModeChangedBlueprintEvent;               // 0x0180(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_3F8[0xD8];                                     // 0x03F8(0x00D8)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UK31DroneMovementComponent) == 0x000540, "Wrong size on UK31DroneMovementComponent");
static_assert(offsetof(UK31DroneMovementComponent, OnDeployLocationChangedEvent) == 0x000140, "Member 'UK31DroneMovementComponent::OnDeployLocationChangedEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, OnAttachToCharacterForDeployChangedEvent) == 0x000150, "Member 'UK31DroneMovementComponent::OnAttachToCharacterForDeployChangedEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, OnAccelerationChangedEvent) == 0x000160, "Member 'UK31DroneMovementComponent::OnAccelerationChangedEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, OnFlightHeightChangedBlueprintEvent) == 0x000170, "Member 'UK31DroneMovementComponent::OnFlightHeightChangedBlueprintEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, OnMovementModeChangedBlueprintEvent) == 0x000180, "Member 'UK31DroneMovementComponent::OnMovementModeChangedBlueprintEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _rotationRate) == 0x000190, "Member 'UK31DroneMovementComponent::_rotationRate' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _rotationLerpTime) == 0x000218, "Member 'UK31DroneMovementComponent::_rotationLerpTime' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _minHeightAboveGround) == 0x000220, "Member 'UK31DroneMovementComponent::_minHeightAboveGround' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _maxHeightAboveGround) == 0x000248, "Member 'UK31DroneMovementComponent::_maxHeightAboveGround' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _heightAdjustmentMovingTime) == 0x000270, "Member 'UK31DroneMovementComponent::_heightAdjustmentMovingTime' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _deployMovementSpeed) == 0x000298, "Member 'UK31DroneMovementComponent::_deployMovementSpeed' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _replicationFrequency) == 0x00029C, "Member 'UK31DroneMovementComponent::_replicationFrequency' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _smoothingTime) == 0x0002A0, "Member 'UK31DroneMovementComponent::_smoothingTime' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _maxSmoothUpdateDistance) == 0x0002A4, "Member 'UK31DroneMovementComponent::_maxSmoothUpdateDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _noSmoothUpdateDistance) == 0x0002A8, "Member 'UK31DroneMovementComponent::_noSmoothUpdateDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _deployCharacterSocket) == 0x0002AC, "Member 'UK31DroneMovementComponent::_deployCharacterSocket' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _maxTravelDistance) == 0x0002B8, "Member 'UK31DroneMovementComponent::_maxTravelDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _maxDeployTime) == 0x0002C0, "Member 'UK31DroneMovementComponent::_maxDeployTime' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _gravity) == 0x0002C4, "Member 'UK31DroneMovementComponent::_gravity' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _velocityInterpolationAlpha) == 0x0002C8, "Member 'UK31DroneMovementComponent::_velocityInterpolationAlpha' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _constantSpeedToAccelerationCurve) == 0x0002D0, "Member 'UK31DroneMovementComponent::_constantSpeedToAccelerationCurve' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _gameState) == 0x000330, "Member 'UK31DroneMovementComponent::_gameState' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _localDeployDatum) == 0x000378, "Member 'UK31DroneMovementComponent::_localDeployDatum' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _interactingActor) == 0x0003A8, "Member 'UK31DroneMovementComponent::_interactingActor' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _additionalRotatingComponents) == 0x0003E0, "Member 'UK31DroneMovementComponent::_additionalRotatingComponents' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _updatedComponentOriginalParent) == 0x0003F0, "Member 'UK31DroneMovementComponent::_updatedComponentOriginalParent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _replicatedMovement) == 0x0004D0, "Member 'UK31DroneMovementComponent::_replicatedMovement' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _repDeployDatum) == 0x000508, "Member 'UK31DroneMovementComponent::_repDeployDatum' has a wrong offset!");
...
static_assert(sizeof(UK31DroneOutlineUpdateStrategy) == 0x000130, "Wrong size on UK31DroneOutlineUpdateStrategy");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _killerColorNormal) == 0x0000C0, "Member 'UK31DroneOutlineUpdateStrategy::_killerColorNormal' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _killerColorActive) == 0x0000D0, "Member 'UK31DroneOutlineUpdateStrategy::_killerColorActive' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _killerColorSelected) == 0x0000E0, "Member 'UK31DroneOutlineUpdateStrategy::_killerColorSelected' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _survivorColor) == 0x0000F0, "Member 'UK31DroneOutlineUpdateStrategy::_survivorColor' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _invalidStates) == 0x000100, "Member 'UK31DroneOutlineUpdateStrategy::_invalidStates' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _killerMinimumDistance) == 0x000110, "Member 'UK31DroneOutlineUpdateStrategy::_killerMinimumDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _survivorMinimumDistance) == 0x000114, "Member 'UK31DroneOutlineUpdateStrategy::_survivorMinimumDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _survivorMaximumDistanceXY) == 0x000118, "Member 'UK31DroneOutlineUpdateStrategy::_survivorMaximumDistanceXY' has a wrong offset!");
...
static_assert(sizeof(UK31DroneOwnershipComponent) == 0x0000E0, "Wrong size on UK31DroneOwnershipComponent");
...
static_assert(sizeof(UK31DronePlacementRecaller) == 0x000130, "Wrong size on UK31DronePlacementRecaller");
static_assert(offsetof(UK31DronePlacementRecaller, _maxDistanceXY) == 0x0000C8, "Member 'UK31DronePlacementRecaller::_maxDistanceXY' has a wrong offset!");
static_assert(offsetof(UK31DronePlacementRecaller, _maxDistanceZ) == 0x0000F0, "Member 'UK31DronePlacementRecaller::_maxDistanceZ' has a wrong offset!");
...
static_assert(sizeof(UK31DronePlacementStrategy) == 0x000168, "Wrong size on UK31DronePlacementStrategy");
static_assert(offsetof(UK31DronePlacementStrategy, _sphereSweepRadius) == 0x0000F0, "Member 'UK31DronePlacementStrategy::_sphereSweepRadius' has a wrong offset!");
static_assert(offsetof(UK31DronePlacementStrategy, _minHeightAboveGround) == 0x000118, "Member 'UK31DronePlacementStrategy::_minHeightAboveGround' has a wrong offset!");
static_assert(offsetof(UK31DronePlacementStrategy, _maxHeightAboveGround) == 0x000140, "Member 'UK31DronePlacementStrategy::_maxHeightAboveGround' has a wrong offset!");
...
static_assert(sizeof(UK31DroneScoutDetectionComponent) == 0x0002B8, "Wrong size on UK31DroneScoutDetectionComponent");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _raycastSphereData) == 0x0000D0, "Member 'UK31DroneScoutDetectionComponent::_raycastSphereData' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _survivorLastFrameData) == 0x0000E0, "Member 'UK31DroneScoutDetectionComponent::_survivorLastFrameData' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _survivorCurrentFrameData) == 0x000130, "Member 'UK31DroneScoutDetectionComponent::_survivorCurrentFrameData' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _detectedSurvivors) == 0x000180, "Member 'UK31DroneScoutDetectionComponent::_detectedSurvivors' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _baseDetectionConeYawHalfAngleDegrees) == 0x000218, "Member 'UK31DroneScoutDetectionComponent::_baseDetectionConeYawHalfAngleDegrees' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _baseDetectionHalfHeight) == 0x000240, "Member 'UK31DroneScoutDetectionComponent::_baseDetectionHalfHeight' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _baseDetectionRadius) == 0x000268, "Member 'UK31DroneScoutDetectionComponent::_baseDetectionRadius' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _sphereTraceRadius) == 0x000290, "Member 'UK31DroneScoutDetectionComponent::_sphereTraceRadius' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UK31DroneState>             _defaultStateClass;                                // 0x0108(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31DroneStateController) == 0x000180, "Wrong size on UK31DroneStateController");
static_assert(offsetof(UK31DroneStateController, OnStateChangedBlueprintEvent) == 0x0000E8, "Member 'UK31DroneStateController::OnStateChangedBlueprintEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneStateController, _stateClasses) == 0x0000F8, "Member 'UK31DroneStateController::_stateClasses' has a wrong offset!");
static_assert(offsetof(UK31DroneStateController, _defaultStateClass) == 0x000108, "Member 'UK31DroneStateController::_defaultStateClass' has a wrong offset!");
static_assert(offsetof(UK31DroneStateController, _gameState) == 0x000110, "Member 'UK31DroneStateController::_gameState' has a wrong offset!");
static_assert(offsetof(UK31DroneStateController, _states) == 0x000128, "Member 'UK31DroneStateController::_states' has a wrong offset!");
static_assert(offsetof(UK31DroneStateController, _local_currentState) == 0x000148, "Member 'UK31DroneStateController::_local_currentState' has a wrong offset!");
static_assert(offsetof(UK31DroneStateController, _authority_RepCurrentState) == 0x000160, "Member 'UK31DroneStateController::_authority_RepCurrentState' has a wrong offset!");
...
public:
	uint8                                         Pad_B8[0x18];                                      // 0x00B8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class ADBDActorIndicator>         _indicatorClass;                                   // 0x00D0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31DroneTargeter) == 0x000148, "Wrong size on UK31DroneTargeter");
static_assert(offsetof(UK31DroneTargeter, _indicatorClass) == 0x0000D0, "Member 'UK31DroneTargeter::_indicatorClass' has a wrong offset!");
static_assert(offsetof(UK31DroneTargeter, _maxAngleFromScreenCenter) == 0x0000D8, "Member 'UK31DroneTargeter::_maxAngleFromScreenCenter' has a wrong offset!");
static_assert(offsetof(UK31DroneTargeter, _indicator) == 0x000120, "Member 'UK31DroneTargeter::_indicator' has a wrong offset!");
static_assert(offsetof(UK31DroneTargeter, _target) == 0x000130, "Member 'UK31DroneTargeter::_target' has a wrong offset!");
...
static_assert(sizeof(UK31DroneZoneComponent) == 0x000180, "Wrong size on UK31DroneZoneComponent");
static_assert(offsetof(UK31DroneZoneComponent, _playerDroneZoneStructMap) == 0x0000D0, "Member 'UK31DroneZoneComponent::_playerDroneZoneStructMap' has a wrong offset!");
static_assert(offsetof(UK31DroneZoneComponent, _maxDistanceXY) == 0x000130, "Member 'UK31DroneZoneComponent::_maxDistanceXY' has a wrong offset!");
static_assert(offsetof(UK31DroneZoneComponent, _maxDistanceZ) == 0x000158, "Member 'UK31DroneZoneComponent::_maxDistanceZ' has a wrong offset!");
...
static_assert(sizeof(UK31HasteEffect) == 0x000350, "Wrong size on UK31HasteEffect");
...
static_assert(sizeof(UK31InspectRadarScoreEmitter) == 0x0000A0, "Wrong size on UK31InspectRadarScoreEmitter");
...
static_assert(sizeof(UK31MenuAnimInstance) == 0x000310, "Wrong size on UK31MenuAnimInstance");
static_assert(offsetof(UK31MenuAnimInstance, _animationSelector) == 0x0002F8, "Member 'UK31MenuAnimInstance::_animationSelector' has a wrong offset!");
...
public:
	...
	float                                         _hasteEffectDurationSeconds[0x3];                  // 0x03CC(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class UStatusEffect>              _hasteEffectClass;                                 // 0x03E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31P01) == 0x000400, "Wrong size on UK31P01");
static_assert(offsetof(UK31P01, _hasteEffectMovementSpeedIncrease) == 0x0003C8, "Member 'UK31P01::_hasteEffectMovementSpeedIncrease' has a wrong offset!");
static_assert(offsetof(UK31P01, _hasteEffectDurationSeconds) == 0x0003CC, "Member 'UK31P01::_hasteEffectDurationSeconds' has a wrong offset!");
static_assert(offsetof(UK31P01, _authority_hasteStatusEffect) == 0x0003D8, "Member 'UK31P01::_authority_hasteStatusEffect' has a wrong offset!");
static_assert(offsetof(UK31P01, _hasteEffectClass) == 0x0003E0, "Member 'UK31P01::_hasteEffectClass' has a wrong offset!");
static_assert(offsetof(UK31P01, _isPerkActive) == 0x0003E8, "Member 'UK31P01::_isPerkActive' has a wrong offset!");
...
{
public:
	TSubclassOf<class UStatusEffect>              _revealAuraToKillerEffectClass;                    // 0x03C8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	float                                         _screamDistance[0x3];                              // 0x03D4(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31P02) == 0x0003E8, "Wrong size on UK31P02");
static_assert(offsetof(UK31P02, _revealAuraToKillerEffectClass) == 0x0003C8, "Member 'UK31P02::_revealAuraToKillerEffectClass' has a wrong offset!");
static_assert(offsetof(UK31P02, _revealAuraSeconds) == 0x0003D0, "Member 'UK31P02::_revealAuraSeconds' has a wrong offset!");
static_assert(offsetof(UK31P02, _screamDistance) == 0x0003D4, "Member 'UK31P02::_screamDistance' has a wrong offset!");
static_assert(offsetof(UK31P02, _isPerkActive) == 0x0003E4, "Member 'UK31P02::_isPerkActive' has a wrong offset!");
...
{
public:
	float                                         _healPenalty[0x3];                                 // 0x03C8(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class UStatusEffect>              _reduceHealingSpeedEffectClass;                    // 0x03D8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31P03) == 0x000400, "Wrong size on UK31P03");
static_assert(offsetof(UK31P03, _healPenalty) == 0x0003C8, "Member 'UK31P03::_healPenalty' has a wrong offset!");
static_assert(offsetof(UK31P03, _reduceHealingSpeedEffectSeconds) == 0x0003D4, "Member 'UK31P03::_reduceHealingSpeedEffectSeconds' has a wrong offset!");
static_assert(offsetof(UK31P03, _reduceHealingSpeedEffectClass) == 0x0003D8, "Member 'UK31P03::_reduceHealingSpeedEffectClass' has a wrong offset!");
static_assert(offsetof(UK31P03, _survivorDebuffs) == 0x0003E0, "Member 'UK31P03::_survivorDebuffs' has a wrong offset!");
...
static_assert(sizeof(UK31PlayerZoneStatus) == 0x000180, "Wrong size on UK31PlayerZoneStatus");
static_assert(offsetof(UK31PlayerZoneStatus, _overlappingZones) == 0x000100, "Member 'UK31PlayerZoneStatus::_overlappingZones' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UK31SurvivorDetection>      _survivorDetectionClass;                           // 0x0508(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class UStatusEffect>              _scannerHasteEffectClass;                          // 0x0528(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class UK31SurvivorClawTrapComponent> _survivorClawTrapComponentClass;                // 0x0618(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AK31Power) == 0x0006F0, "Wrong size on AK31Power");
static_assert(offsetof(AK31Power, _powerChargePresentationItemProgressComponent) == 0x0004F8, "Member 'AK31Power::_powerChargePresentationItemProgressComponent' has a wrong offset!");
static_assert(offsetof(AK31Power, _powerChargePresentationPowerFadeComponent) == 0x000500, "Member 'AK31Power::_powerChargePresentationPowerFadeComponent' has a wrong offset!");
static_assert(offsetof(AK31Power, _survivorDetectionClass) == 0x000508, "Member 'AK31Power::_survivorDetectionClass' has a wrong offset!");
static_assert(offsetof(AK31Power, _effects) == 0x000510, "Member 'AK31Power::_effects' has a wrong offset!");
static_assert(offsetof(AK31Power, _authority_scannerHasteEffect) == 0x000520, "Member 'AK31Power::_authority_scannerHasteEffect' has a wrong offset!");
static_assert(offsetof(AK31Power, _scannerHasteEffectClass) == 0x000528, "Member 'AK31Power::_scannerHasteEffectClass' has a wrong offset!");
static_assert(offsetof(AK31Power, _interactor) == 0x000530, "Member 'AK31Power::_interactor' has a wrong offset!");
static_assert(offsetof(AK31Power, _poolInitializer) == 0x000538, "Member 'AK31Power::_poolInitializer' has a wrong offset!");
static_assert(offsetof(AK31Power, _dronePool) == 0x000540, "Member 'AK31Power::_dronePool' has a wrong offset!");
static_assert(offsetof(AK31Power, _scanner) == 0x000548, "Member 'AK31Power::_scanner' has a wrong offset!");
static_assert(offsetof(AK31Power, _powerState) == 0x000580, "Member 'AK31Power::_powerState' has a wrong offset!");
static_assert(offsetof(AK31Power, _effectSpawner) == 0x000590, "Member 'AK31Power::_effectSpawner' has a wrong offset!");
static_assert(offsetof(AK31Power, _survivorClawTrapComponentClass) == 0x000618, "Member 'AK31Power::_survivorClawTrapComponentClass' has a wrong offset!");
static_assert(offsetof(AK31Power, _powerCooldownTimer) == 0x000620, "Member 'AK31Power::_powerCooldownTimer' has a wrong offset!");
static_assert(offsetof(AK31Power, _powerCooldownDuration) == 0x000660, "Member 'AK31Power::_powerCooldownDuration' has a wrong offset!");
static_assert(offsetof(AK31Power, _hasteCurveBasedOnScannedSurvivors) == 0x0006E8, "Member 'AK31Power::_hasteCurveBasedOnScannedSurvivors' has a wrong offset!");
...
static_assert(sizeof(UK31PowerChargePresentationPowerFadeComponent) == 0x0000C0, "Wrong size on UK31PowerChargePresentationPowerFadeComponent");
static_assert(offsetof(UK31PowerChargePresentationPowerFadeComponent, _originatingPower) == 0x0000B8, "Member 'UK31PowerChargePresentationPowerFadeComponent::_originatingPower' has a wrong offset!");
...
static_assert(sizeof(UK31PowerCosmeticHelper) == 0x0000D8, "Wrong size on UK31PowerCosmeticHelper");
...
static_assert(sizeof(UK31PowerSubAnimInstance) == 0x000320, "Wrong size on UK31PowerSubAnimInstance");
static_assert(offsetof(UK31PowerSubAnimInstance, _isChargingInspection) == 0x0002F0, "Member 'UK31PowerSubAnimInstance::_isChargingInspection' has a wrong offset!");
static_assert(offsetof(UK31PowerSubAnimInstance, _inspectPlayRate) == 0x0002F4, "Member 'UK31PowerSubAnimInstance::_inspectPlayRate' has a wrong offset!");
static_assert(offsetof(UK31PowerSubAnimInstance, _inspectSequenceStartPosition) == 0x0002F8, "Member 'UK31PowerSubAnimInstance::_inspectSequenceStartPosition' has a wrong offset!");
static_assert(offsetof(UK31PowerSubAnimInstance, _inspectSequence) == 0x000300, "Member 'UK31PowerSubAnimInstance::_inspectSequence' has a wrong offset!");
...
static_assert(sizeof(UK31RadarAnimInstance) == 0x000300, "Wrong size on UK31RadarAnimInstance");
static_assert(offsetof(UK31RadarAnimInstance, _isRecallingADrone) == 0x0002C0, "Member 'UK31RadarAnimInstance::_isRecallingADrone' has a wrong offset!");
static_assert(offsetof(UK31RadarAnimInstance, _isActivatingADrone) == 0x0002C1, "Member 'UK31RadarAnimInstance::_isActivatingADrone' has a wrong offset!");
static_assert(offsetof(UK31RadarAnimInstance, _isAbleToPlaceDrone) == 0x0002C2, "Member 'UK31RadarAnimInstance::_isAbleToPlaceDrone' has a wrong offset!");
static_assert(offsetof(UK31RadarAnimInstance, _isPowerOnCooldown) == 0x0002C3, "Member 'UK31RadarAnimInstance::_isPowerOnCooldown' has a wrong offset!");
static_assert(offsetof(UK31RadarAnimInstance, _owningK31Power) == 0x0002C8, "Member 'UK31RadarAnimInstance::_owningK31Power' has a wrong offset!");
static_assert(offsetof(UK31RadarAnimInstance, _killer) == 0x0002D0, "Member 'UK31RadarAnimInstance::_killer' has a wrong offset!");
...
public:
	...
	TSet<class ADBDPlayer*>                       _playersShownOnRadar;                              // 0x01D0(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31Scanner) == 0x000228, "Wrong size on UK31Scanner");
static_assert(offsetof(UK31Scanner, OnScannerUpdated) == 0x0000B8, "Member 'UK31Scanner::OnScannerUpdated' has a wrong offset!");
static_assert(offsetof(UK31Scanner, _radarRadius) == 0x0000E0, "Member 'UK31Scanner::_radarRadius' has a wrong offset!");
static_assert(offsetof(UK31Scanner, _levelHeightThreshold) == 0x000168, "Member 'UK31Scanner::_levelHeightThreshold' has a wrong offset!");
static_assert(offsetof(UK31Scanner, _debugPointTexture) == 0x000190, "Member 'UK31Scanner::_debugPointTexture' has a wrong offset!");
static_assert(offsetof(UK31Scanner, _owningActor) == 0x0001B8, "Member 'UK31Scanner::_owningActor' has a wrong offset!");
static_assert(offsetof(UK31Scanner, _playersShownOnRadar) == 0x0001D0, "Member 'UK31Scanner::_playersShownOnRadar' has a wrong offset!");
...
static_assert(sizeof(UK31SurvivorAnimInstance) == 0x000570, "Wrong size on UK31SurvivorAnimInstance");
static_assert(offsetof(UK31SurvivorAnimInstance, _hasBeenSpottedByDrone) == 0x000550, "Member 'UK31SurvivorAnimInstance::_hasBeenSpottedByDrone' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isInsideAnActiveDroneZone) == 0x000551, "Member 'UK31SurvivorAnimInstance::_isInsideAnActiveDroneZone' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isClawTrapped) == 0x000552, "Member 'UK31SurvivorAnimInstance::_isClawTrapped' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isRemovingClawTrap) == 0x000553, "Member 'UK31SurvivorAnimInstance::_isRemovingClawTrap' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isHackingDrone) == 0x000554, "Member 'UK31SurvivorAnimInstance::_isHackingDrone' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _walkAnimSpeed) == 0x000558, "Member 'UK31SurvivorAnimInstance::_walkAnimSpeed' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isCrawling) == 0x00055C, "Member 'UK31SurvivorAnimInstance::_isCrawling' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isInsideCloset) == 0x00055D, "Member 'UK31SurvivorAnimInstance::_isInsideCloset' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isDead) == 0x00055E, "Member 'UK31SurvivorAnimInstance::_isDead' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isInteracting) == 0x00055F, "Member 'UK31SurvivorAnimInstance::_isInteracting' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isInjured) == 0x000560, "Member 'UK31SurvivorAnimInstance::_isInjured' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isCrouched) == 0x000561, "Member 'UK31SurvivorAnimInstance::_isCrouched' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isHooked) == 0x000562, "Member 'UK31SurvivorAnimInstance::_isHooked' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isIdle) == 0x000563, "Member 'UK31SurvivorAnimInstance::_isIdle' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isUsingAimItem) == 0x000564, "Member 'UK31SurvivorAnimInstance::_isUsingAimItem' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isInAir) == 0x000565, "Member 'UK31SurvivorAnimInstance::_isInAir' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isBeingHealed) == 0x000566, "Member 'UK31SurvivorAnimInstance::_isBeingHealed' has a wrong offset!");
static_assert(offsetof(UK31SurvivorAnimInstance, _isBeingCarried) == 0x000567, "Member 'UK31SurvivorAnimInstance::_isBeingCarried' has a wrong offset!");
...
public:
	...
	TSubclassOf<class USurvivorRemoveClawTrapInteraction> _removeClawTrapInteractionClass;           // 0x00E8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class AK31ClawTrap>               _clawTrapClass;                                    // 0x00F8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31SurvivorClawTrapComponent) == 0x0001D0, "Wrong size on UK31SurvivorClawTrapComponent");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _batteryChargeTimer) == 0x0000C0, "Member 'UK31SurvivorClawTrapComponent::_batteryChargeTimer' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _originatingPower) == 0x0000D0, "Member 'UK31SurvivorClawTrapComponent::_originatingPower' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _isTrapped) == 0x0000D8, "Member 'UK31SurvivorClawTrapComponent::_isTrapped' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _isBroadcasting) == 0x0000D9, "Member 'UK31SurvivorClawTrapComponent::_isBroadcasting' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _removeClawTrapInteraction) == 0x0000E0, "Member 'UK31SurvivorClawTrapComponent::_removeClawTrapInteraction' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _removeClawTrapInteractionClass) == 0x0000E8, "Member 'UK31SurvivorClawTrapComponent::_removeClawTrapInteractionClass' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _clawTrap) == 0x0000F0, "Member 'UK31SurvivorClawTrapComponent::_clawTrap' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _clawTrapClass) == 0x0000F8, "Member 'UK31SurvivorClawTrapComponent::_clawTrapClass' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _clawTrapAttachSocket) == 0x000100, "Member 'UK31SurvivorClawTrapComponent::_clawTrapAttachSocket' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _authority_playerZoneStatus) == 0x000110, "Member 'UK31SurvivorClawTrapComponent::_authority_playerZoneStatus' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _lastUntrapDatum) == 0x000118, "Member 'UK31SurvivorClawTrapComponent::_lastUntrapDatum' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _wasLastRemovedAutomatically) == 0x000120, "Member 'UK31SurvivorClawTrapComponent::_wasLastRemovedAutomatically' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _authority_originatingDrone) == 0x000128, "Member 'UK31SurvivorClawTrapComponent::_authority_originatingDrone' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _batteryMaxCharge) == 0x000130, "Member 'UK31SurvivorClawTrapComponent::_batteryMaxCharge' has a wrong offset!");
...
static_assert(sizeof(AK31SurvivorCosmeticHelperActor) == 0x0002C8, "Wrong size on AK31SurvivorCosmeticHelperActor");
static_assert(offsetof(AK31SurvivorCosmeticHelperActor, _playerZoneStatus) == 0x000268, "Member 'AK31SurvivorCosmeticHelperActor::_playerZoneStatus' has a wrong offset!");
static_assert(offsetof(AK31SurvivorCosmeticHelperActor, _enterActiveZoneCosmeticCooldown) == 0x0002A0, "Member 'AK31SurvivorCosmeticHelperActor::_enterActiveZoneCosmeticCooldown' has a wrong offset!");
...
public:
	uint8                                         Pad_B8[0x8];                                       // 0x00B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UK31SurvivorExposedEffect>  _effectClass;                                      // 0x00C0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31SurvivorDetection) == 0x000470, "Wrong size on UK31SurvivorDetection");
static_assert(offsetof(UK31SurvivorDetection, _effectClass) == 0x0000C0, "Member 'UK31SurvivorDetection::_effectClass' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _secondsToCharge) == 0x0000C8, "Member 'UK31SurvivorDetection::_secondsToCharge' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _chargeRate) == 0x000150, "Member 'UK31SurvivorDetection::_chargeRate' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _chargeModifierWhenClawTrapped) == 0x0001D8, "Member 'UK31SurvivorDetection::_chargeModifierWhenClawTrapped' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _dechargeDelay) == 0x000260, "Member 'UK31SurvivorDetection::_dechargeDelay' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _dechargeRate) == 0x0002E8, "Member 'UK31SurvivorDetection::_dechargeRate' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _fullyLockedOnDuration) == 0x000370, "Member 'UK31SurvivorDetection::_fullyLockedOnDuration' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _playerZoneStatus) == 0x0003F8, "Member 'UK31SurvivorDetection::_playerZoneStatus' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _originatingPower) == 0x000400, "Member 'UK31SurvivorDetection::_originatingPower' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _chargingLockedOnChargeableComponent) == 0x000408, "Member 'UK31SurvivorDetection::_chargingLockedOnChargeableComponent' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _fullyLockedOnTimer) == 0x000410, "Member 'UK31SurvivorDetection::_fullyLockedOnTimer' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _isFullyLockedOn) == 0x000418, "Member 'UK31SurvivorDetection::_isFullyLockedOn' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _effect) == 0x000420, "Member 'UK31SurvivorDetection::_effect' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _overlappingDrones) == 0x000428, "Member 'UK31SurvivorDetection::_overlappingDrones' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _overlappingActiveDrones) == 0x000438, "Member 'UK31SurvivorDetection::_overlappingActiveDrones' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _lastActiveTime) == 0x000448, "Member 'UK31SurvivorDetection::_lastActiveTime' has a wrong offset!");
...
static_assert(sizeof(UK31SurvivorExposedEffect) == 0x000360, "Wrong size on UK31SurvivorExposedEffect");
...
static_assert(sizeof(UK31SurvivorInActiveZoneCondition) == 0x0000E8, "Wrong size on UK31SurvivorInActiveZoneCondition");
...
public:
	...
	TSet<class UGameplayTagContainerComponent*>   _registeredObjectStates;                           // 0x00F0(0x0050)(ExportObject, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TSet<class ADBDPlayer*>                       _trappedPlayersInZone;                             // 0x0140(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UK31TrapProximitySensor) == 0x000198, "Wrong size on UK31TrapProximitySensor");
static_assert(offsetof(UK31TrapProximitySensor, _registeredObjectStates) == 0x0000F0, "Member 'UK31TrapProximitySensor::_registeredObjectStates' has a wrong offset!");
static_assert(offsetof(UK31TrapProximitySensor, _trappedPlayersInZone) == 0x000140, "Member 'UK31TrapProximitySensor::_trappedPlayersInZone' has a wrong offset!");
...
static_assert(sizeof(UK31UndetectableEffect) == 0x0004A0, "Wrong size on UK31UndetectableEffect");
static_assert(offsetof(UK31UndetectableEffect, _activateDelay) == 0x000358, "Member 'UK31UndetectableEffect::_activateDelay' has a wrong offset!");
static_assert(offsetof(UK31UndetectableEffect, _lingerDurationStat) == 0x0003E0, "Member 'UK31UndetectableEffect::_lingerDurationStat' has a wrong offset!");
static_assert(offsetof(UK31UndetectableEffect, _zoneStatus) == 0x000468, "Member 'UK31UndetectableEffect::_zoneStatus' has a wrong offset!");
...
static_assert(sizeof(UK31WeakPointScoreEmitter) == 0x000098, "Wrong size on UK31WeakPointScoreEmitter");
static_assert(offsetof(UK31WeakPointScoreEmitter, _registeredSurvivors) == 0x000048, "Member 'UK31WeakPointScoreEmitter::_registeredSurvivors' has a wrong offset!");
...
{
public:
	TSet<class AActor*>                           _alreadyProcessedSurvivors;                        // 0x0080(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UKillerMakeUniqueSurvivorsScreamAchievement) == 0x0000D0, "Wrong size on UKillerMakeUniqueSurvivorsScreamAchievement");
static_assert(offsetof(UKillerMakeUniqueSurvivorsScreamAchievement, _alreadyProcessedSurvivors) == 0x000080, "Member 'UKillerMakeUniqueSurvivorsScreamAchievement::_alreadyProcessedSurvivors' has a wrong offset!");
...
{
public:
	float                                         _fastVaultsTimeSeconds[0x3];                       // 0x03C8(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(US35P01) == 0x0003E8, "Wrong size on US35P01");
static_assert(offsetof(US35P01, _fastVaultsTimeSeconds) == 0x0003C8, "Member 'US35P01::_fastVaultsTimeSeconds' has a wrong offset!");
static_assert(offsetof(US35P01, _cooldownDurationSeconds) == 0x0003D4, "Member 'US35P01::_cooldownDurationSeconds' has a wrong offset!");
...
{
public:
	float                                         _hasteEffectDurationSeconds[0x3];                  // 0x03C8(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class UStatusEffect>              _hasteEffectClass;                                 // 0x03D8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(US35P02) == 0x000440, "Wrong size on US35P02");
static_assert(offsetof(US35P02, _hasteEffectDurationSeconds) == 0x0003C8, "Member 'US35P02::_hasteEffectDurationSeconds' has a wrong offset!");
static_assert(offsetof(US35P02, _hasteEffectMovementSpeedIncrease) == 0x0003D4, "Member 'US35P02::_hasteEffectMovementSpeedIncrease' has a wrong offset!");
static_assert(offsetof(US35P02, _hasteEffectClass) == 0x0003D8, "Member 'US35P02::_hasteEffectClass' has a wrong offset!");
static_assert(offsetof(US35P02, _survivorBuffs) == 0x0003E0, "Member 'US35P02::_survivorBuffs' has a wrong offset!");
...
static_assert(sizeof(US35P02Effect) == 0x000358, "Wrong size on US35P02Effect");

// Class TheK31.S35P03
// 0x0098 (0x0460 - 0x03C8)
class US35P03 final : public UPerk
{
public:
	...
	float                                         _cooldownDuration[0x3];                            // 0x03CC(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class US35P03Effect>              _hasteEffectClass;                                 // 0x03E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(US35P03) == 0x000460, "Wrong size on US35P03");
static_assert(offsetof(US35P03, _isStatusEffectActiveOnOwningSurvivor) == 0x0003C8, "Member 'US35P03::_isStatusEffectActiveOnOwningSurvivor' has a wrong offset!");
static_assert(offsetof(US35P03, _cooldownDuration) == 0x0003CC, "Member 'US35P03::_cooldownDuration' has a wrong offset!");
static_assert(offsetof(US35P03, _speedBoost) == 0x0003D8, "Member 'US35P03::_speedBoost' has a wrong offset!");
static_assert(offsetof(US35P03, _perkRange) == 0x0003DC, "Member 'US35P03::_perkRange' has a wrong offset!");
static_assert(offsetof(US35P03, _hasteEffectClass) == 0x0003E0, "Member 'US35P03::_hasteEffectClass' has a wrong offset!");
static_assert(offsetof(US35P03, _healedSurvivorsAffected) == 0x0003E8, "Member 'US35P03::_healedSurvivorsAffected' has a wrong offset!");

// Class TheK31.S35P03Effect
// 0x0018 (0x0368 - 0x0350)
class US35P03Effect final : public UStatusEffect
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"S35P03Effect">();
	}
	static class US35P03Effect* GetDefaultObj()
	{
		return GetDefaultObjImpl<US35P03Effect>();
	}
};
static_assert(alignof(US35P03Effect) == 0x000008, "Wrong alignment on US35P03Effect");
static_assert(sizeof(US35P03Effect) == 0x000368, "Wrong size on US35P03Effect");
static_assert(offsetof(US35P03Effect, _shouldGiveBuff) == 0x000360, "Member 'US35P03Effect::_shouldGiveBuff' has a wrong offset!");
static_assert(offsetof(US35P03Effect, _isStatusEffectGivenToSelf) == 0x000361, "Member 'US35P03Effect::_isStatusEffectGivenToSelf' has a wrong offset!");
...
public:
	...
	float                                         _activationDurationSeconds[0x3];                   // 0x03D0(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         _exhaustedEffectDurationSeconds[0x3];              // 0x03DC(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class UStatusEffect>              _hasteEffectClass;                                 // 0x03F0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class UActivatableExhaustedEffect> _exhaustedEffectClass;                            // 0x0400(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(US36P01) == 0x000418, "Wrong size on US36P01");
static_assert(offsetof(US36P01, _hasteEffectDurationSeconds) == 0x0003C8, "Member 'US36P01::_hasteEffectDurationSeconds' has a wrong offset!");
static_assert(offsetof(US36P01, _hasteEffectMovementSpeedIncrease) == 0x0003CC, "Member 'US36P01::_hasteEffectMovementSpeedIncrease' has a wrong offset!");
static_assert(offsetof(US36P01, _activationDurationSeconds) == 0x0003D0, "Member 'US36P01::_activationDurationSeconds' has a wrong offset!");
static_assert(offsetof(US36P01, _exhaustedEffectDurationSeconds) == 0x0003DC, "Member 'US36P01::_exhaustedEffectDurationSeconds' has a wrong offset!");
static_assert(offsetof(US36P01, _hasteStatusEffect) == 0x0003E8, "Member 'US36P01::_hasteStatusEffect' has a wrong offset!");
static_assert(offsetof(US36P01, _hasteEffectClass) == 0x0003F0, "Member 'US36P01::_hasteEffectClass' has a wrong offset!");
static_assert(offsetof(US36P01, _exhaustedStatusEffect) == 0x0003F8, "Member 'US36P01::_exhaustedStatusEffect' has a wrong offset!");
static_assert(offsetof(US36P01, _exhaustedEffectClass) == 0x000400, "Member 'US36P01::_exhaustedEffectClass' has a wrong offset!");
...
{
public:
	float                                         _brokenStatusEffectSeconds[0x3];                   // 0x03C8(0x0004)(Edit, EditFixedSize, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         _requiredHookStage;                                // 0x03D4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         _currentHookStage;                                 // 0x03D8(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3DC[0x4];                                      // 0x03DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UInteractionDefinition>     _perkInteractionClass;                             // 0x03E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSubclassOf<class UStatusEffect>              _brokenEffectClass;                                // 0x03F8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UStatusEffect>              _exhaustedEffectClass;                             // 0x0400(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(US36P02) == 0x000410, "Wrong size on US36P02");
static_assert(offsetof(US36P02, _brokenStatusEffectSeconds) == 0x0003C8, "Member 'US36P02::_brokenStatusEffectSeconds' has a wrong offset!");
static_assert(offsetof(US36P02, _requiredHookStage) == 0x0003D4, "Member 'US36P02::_requiredHookStage' has a wrong offset!");
static_assert(offsetof(US36P02, _currentHookStage) == 0x0003D8, "Member 'US36P02::_currentHookStage' has a wrong offset!");
static_assert(offsetof(US36P02, _perkInteractionClass) == 0x0003E0, "Member 'US36P02::_perkInteractionClass' has a wrong offset!");
static_assert(offsetof(US36P02, _perkInteraction) == 0x0003E8, "Member 'US36P02::_perkInteraction' has a wrong offset!");
static_assert(offsetof(US36P02, _brokenStatusEffect) == 0x0003F0, "Member 'US36P02::_brokenStatusEffect' has a wrong offset!");
static_assert(offsetof(US36P02, _brokenEffectClass) == 0x0003F8, "Member 'US36P02::_brokenEffectClass' has a wrong offset!");
static_assert(offsetof(US36P02, _exhaustedEffectClass) == 0x000400, "Member 'US36P02::_exhaustedEffectClass' has a wrong offset!");
...
static_assert(sizeof(US36P02Interaction) == 0x000620, "Wrong size on US36P02Interaction");

// Class TheK31.S36P03
// 0x0098 (0x0460 - 0x03C8)
class US36P03 final : public UPerk
{
public:
	bool                                          _isStatusEffectActiveOnOwningSurvivor;             // 0x03C8(0x0001)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3C9[0x3];                                      // 0x03C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3DC[0x4];                                      // 0x03DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class US36P03Effect>              _noScratchMarksEffectClass;                        // 0x03E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(US36P03) == 0x000460, "Wrong size on US36P03");
static_assert(offsetof(US36P03, _isStatusEffectActiveOnOwningSurvivor) == 0x0003C8, "Member 'US36P03::_isStatusEffectActiveOnOwningSurvivor' has a wrong offset!");
static_assert(offsetof(US36P03, _cooldownDuration) == 0x0003CC, "Member 'US36P03::_cooldownDuration' has a wrong offset!");
static_assert(offsetof(US36P03, _perkRange) == 0x0003D8, "Member 'US36P03::_perkRange' has a wrong offset!");
static_assert(offsetof(US36P03, _noScratchMarksEffectClass) == 0x0003E0, "Member 'US36P03::_noScratchMarksEffectClass' has a wrong offset!");
static_assert(offsetof(US36P03, _healersAffected) == 0x0003E8, "Member 'US36P03::_healersAffected' has a wrong offset!");

// Class TheK31.S36P03Effect
// 0x0018 (0x0368 - 0x0350)
class US36P03Effect final : public UStatusEffect
{
public:
	uint8                                         Pad_350[0x10];                                     // 0x0350(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          _shouldGiveBuff;                                   // 0x0360(0x0001)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"S36P03Effect">();
	}
	static class US36P03Effect* GetDefaultObj()
	{
		return GetDefaultObjImpl<US36P03Effect>();
	}
};
static_assert(alignof(US36P03Effect) == 0x000008, "Wrong alignment on US36P03Effect");
static_assert(sizeof(US36P03Effect) == 0x000368, "Wrong size on US36P03Effect");
static_assert(offsetof(US36P03Effect, _shouldGiveBuff) == 0x000360, "Member 'US36P03Effect::_shouldGiveBuff' has a wrong offset!");
static_assert(offsetof(US36P03Effect, _isStatusEffectGivenToSelf) == 0x000361, "Member 'US36P03Effect::_isStatusEffectGivenToSelf' has a wrong offset!");
...
static_assert(sizeof(USurvivorHackDroneInteraction) == 0x0006D0, "Wrong size on USurvivorHackDroneInteraction");
static_assert(offsetof(USurvivorHackDroneInteraction, _isHackingComplete) == 0x000638, "Member 'USurvivorHackDroneInteraction::_isHackingComplete' has a wrong offset!");
static_assert(offsetof(USurvivorHackDroneInteraction, _batteryStartingChargePercent) == 0x000640, "Member 'USurvivorHackDroneInteraction::_batteryStartingChargePercent' has a wrong offset!");
static_assert(offsetof(USurvivorHackDroneInteraction, _playerSnapSocket) == 0x000668, "Member 'USurvivorHackDroneInteraction::_playerSnapSocket' has a wrong offset!");
static_assert(offsetof(USurvivorHackDroneInteraction, _maximumTimeToAttemptDuration) == 0x000678, "Member 'USurvivorHackDroneInteraction::_maximumTimeToAttemptDuration' has a wrong offset!");
...
{
public:
	bool                                          _isHackingComplete;                                // 0x0618(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USurvivorRemoveClawTrapInteraction) == 0x0006D0, "Wrong size on USurvivorRemoveClawTrapInteraction");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _isHackingComplete) == 0x000618, "Member 'USurvivorRemoveClawTrapInteraction::_isHackingComplete' has a wrong offset!");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _survivorClawTrapComponent) == 0x000620, "Member 'USurvivorRemoveClawTrapInteraction::_survivorClawTrapComponent' has a wrong offset!");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _batteryRechargeOnFailedRemovalPercent) == 0x000628, "Member 'USurvivorRemoveClawTrapInteraction::_batteryRechargeOnFailedRemovalPercent' has a wrong offset!");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _requiredTimeToRemainStillBeforeInteractingDuration) == 0x000650, "Member 'USurvivorRemoveClawTrapInteraction::_requiredTimeToRemainStillBeforeInteractingDuration' has a wrong offset!");
