...
struct alignas(0x04) FAimDirection final
{
public:
	uint8                                         Pad_0[0x24];                                       // 0x0000(0x0024)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAimDirection) == 0x000004, "Wrong alignment on FAimDirection");
static_assert(sizeof(FAimDirection) == 0x000024, "Wrong size on FAimDirection");
...
static_assert(sizeof(FAITerrorEvent) == 0x000028, "Wrong size on FAITerrorEvent");
static_assert(offsetof(FAITerrorEvent, Location) == 0x000000, "Member 'FAITerrorEvent::Location' has a wrong offset!");
static_assert(offsetof(FAITerrorEvent, Instigator) == 0x000010, "Member 'FAITerrorEvent::Instigator' has a wrong offset!");
static_assert(offsetof(FAITerrorEvent, TerrorEmitter) == 0x000018, "Member 'FAITerrorEvent::TerrorEmitter' has a wrong offset!");
static_assert(offsetof(FAITerrorEvent, TeamIdentifier) == 0x000020, "Member 'FAITerrorEvent::TeamIdentifier' has a wrong offset!");
...
static_assert(sizeof(FBlindTargetViewData) == 0x000040, "Wrong size on FBlindTargetViewData");
...
{
public:
	TSubclassOf<class UStatusEffect>              _effectClass;                                      // 0x0000(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
