...
static_assert(offsetof(FAnimNode_AnimDynamics, bHardLinkChain) == 0x000154, "Member 'FAnimNode_AnimDynamics::bHardLinkChain' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, BoundBone) == 0x000158, "Member 'FAnimNode_AnimDynamics::BoundBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ChainEnd) == 0x00016C, "Member 'FAnimNode_AnimDynamics::ChainEnd' has a wrong offset!");
