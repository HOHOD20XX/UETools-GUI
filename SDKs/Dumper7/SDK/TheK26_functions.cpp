...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TDelegate<void(const int32 maxAmmo)>    callback                                               (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
...
void UK26P01::Authority_OnBlockTimerDone(class AGenerator* generator)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("K26P01", "Authority_OnBlockTimerDone");

	Params::K26P01_Authority_OnBlockTimerDone Parms{};
...
void UK26P02::Cosmetic_MakeSurvivorScream(const class ADBDPlayer* screamingSurvivor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("K26P02", "Cosmetic_MakeSurvivorScream");

	Params::K26P02_Cosmetic_MakeSurvivorScream Parms{};
...
void UK26P02::Multicast_TriggerPerk(class AGenerator* explodingGenerator)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("K26P02", "Multicast_TriggerPerk");

	Params::K26P02_Multicast_TriggerPerk Parms{};
