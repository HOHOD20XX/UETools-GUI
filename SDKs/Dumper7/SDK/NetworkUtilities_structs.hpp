...
static_assert(alignof(FYawAndPitchRotator_NetQuantize16) == 0x000004, "Wrong alignment on FYawAndPitchRotator_NetQuantize16");
static_assert(sizeof(FYawAndPitchRotator_NetQuantize16) == 0x00000C, "Wrong size on FYawAndPitchRotator_NetQuantize16");
...
static_assert(sizeof(FAssetNetIdRow) == 0x000010, "Wrong size on FAssetNetIdRow");
...
static_assert(alignof(FYawAndPitchRotator_NetQuantize32) == 0x000004, "Wrong alignment on FYawAndPitchRotator_NetQuantize32");
static_assert(sizeof(FYawAndPitchRotator_NetQuantize32) == 0x00000C, "Wrong size on FYawAndPitchRotator_NetQuantize32");
