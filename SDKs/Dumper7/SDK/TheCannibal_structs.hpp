...
static_assert(sizeof(FCannibalAnalytics) == 0x0000E8, "Wrong size on FCannibalAnalytics");
static_assert(offsetof(FCannibalAnalytics, HitWithPowerChargeEvents) == 0x0000C8, "Member 'FCannibalAnalytics::HitWithPowerChargeEvents' has a wrong offset!");
static_assert(offsetof(FCannibalAnalytics, RevToTantrumEvents) == 0x0000D8, "Member 'FCannibalAnalytics::RevToTantrumEvents' has a wrong offset!");
